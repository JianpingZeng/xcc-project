...
public enum DiagnosticSemaKinds implements DiagnosticSemaTag
{
	...
	ERR_ASM_UNKNOWN_REGISTER_NAME(err_asm_unknown_register_name,CLASS_ERROR, MAP_ERROR, "unknown register name '%0' in asm"),
	...
	ERR_BAD_VARIABLE_NAME(err_bad_variable_name,CLASS_ERROR, MAP_ERROR, "'%0' cannot be the name of a variable or data member"),
	...
	ERR_BASE_INIT_DOES_NOT_NAME_CLASS(err_base_init_does_not_name_class,CLASS_ERROR, MAP_ERROR, "constructor initializer %0 does not name a class"),
	ERR_BASE_MUST_BE_CLASS(err_base_must_be_class,CLASS_ERROR, MAP_ERROR, "base specifier must name a class"),
	...
	ERR_CONFLICTING_SUPER_CLASS(err_conflicting_super_class,CLASS_ERROR, MAP_ERROR, "conflicting super class name %0"),
	...
	ERR_DESTRUCTOR_NAME(err_destructor_name,CLASS_ERROR, MAP_ERROR, "expected the class name after '~' to name the enclosing class"),
	...
	ERR_DESTRUCTOR_TYPEDEF_NAME(err_destructor_typedef_name,CLASS_ERROR, MAP_ERROR, "destructor cannot be declared using a typedef %0 of the class name"),
	...
	ERR_EXT_VECTOR_COMPONENT_NAME_ILLEGAL(err_ext_vector_component_name_illegal,CLASS_ERROR, MAP_ERROR, "illegal vector component name '%0'"),
	...
	ERR_INCOMPLETE_NESTED_NAME_SPEC(err_incomplete_nested_name_spec,CLASS_ERROR, MAP_ERROR, "incomplete type %0 named in nested name specifier"),
	...
	ERR_INTRODUCING_SPECIAL_FRIEND(err_introducing_special_friend,CLASS_ERROR, MAP_ERROR, "must use a qualified name when declaring a %select{constructor|destructor|conversion operator}0 as a friend"),
	...
	ERR_INVALID_DECLARATOR_GLOBAL_SCOPE(err_invalid_declarator_global_scope,CLASS_ERROR, MAP_ERROR, "definition or redeclaration of %0 cannot name the global scope"),
	...
	ERR_MEM_INIT_NOT_MEMBER_OR_CLASS(err_mem_init_not_member_or_class,CLASS_ERROR, MAP_ERROR, "member initializer %0 does not name a non-static data member or base class"),
	...
	ERR_NOT_TAG_IN_SCOPE(err_not_tag_in_scope,CLASS_ERROR, MAP_ERROR, "%0 does not name a tag member in the specified scope"),
	...
	ERR_PARAMETER_NAME_OMITTED(err_parameter_name_omitted,CLASS_ERROR, MAP_ERROR, "parameter name omitted"),
	...
	ERR_TAG_DEFINITION_OF_TYPEDEF(err_tag_definition_of_typedef,CLASS_ERROR, MAP_ERROR, "definition of type %0 conflicts with typedef of the same name"),
	...
	ERR_TEMPLATE_QUALIFIED_DECLARATOR_NO_MATCH(err_template_qualified_declarator_no_match,CLASS_ERROR, MAP_ERROR, "nested name specifier '%0' for declaration does not refer to a class template or class template partial specialization"),
	...
	ERR_TEMPLATE_UNNAMED_CLASS(err_template_unnamed_class,CLASS_ERROR, MAP_ERROR, "cannot declare a class template with no name"),
	...
	ERR_UNEXPECTED_INTERFACE(err_unexpected_interface,CLASS_ERROR, MAP_ERROR, "unexpected interface name %0: expected expression"),
	ERR_UNEXPECTED_NAMESPACE(err_unexpected_namespace,CLASS_ERROR, MAP_ERROR, "unexpected namespace name %0: expected expression"),
	ERR_UNEXPECTED_TYPEDEF(err_unexpected_typedef,CLASS_ERROR, MAP_ERROR, "unexpected type name %0: expected expression"),
	...
	ERR_USE_WITH_WRONG_TAG(err_use_with_wrong_tag,CLASS_ERROR, MAP_ERROR, "use of %0 with tag type that does not match previous declaration"),
	ERR_USING_REQUIRES_QUALNAME(err_using_requires_qualname,CLASS_ERROR, MAP_ERROR, "using declaration requires a qualified name"),
	...
	ERROR_MISSING_PROPERTY_IVAR_DECL(error_missing_property_ivar_decl,CLASS_ERROR, MAP_ERROR, "synthesized property %0 must either be named the same as a compatible ivar or must explicitly name an ivar"),
	...
	EXT_TYPEDEF_WITHOUT_A_NAME(ext_typedef_without_a_name, CLASS_NOTE, MAP_WARNING, "typedef requires a name"),
	...
	NOTE_AMBIGUOUS_CANDIDATE(note_ambiguous_candidate, CLASS_NOTE, MAP_FATAL, "candidate found by name lookup is %q0"),
	NOTE_AMBIGUOUS_MEMBER_FOUND(note_ambiguous_member_found, CLASS_NOTE, MAP_FATAL, "member found by ambiguous name lookup"),
	...
	WARN_PRAGMA_PACK_POP_IDENTIFER_AND_ALIGNMENT(warn_pragma_pack_pop_identifer_and_alignment, CLASS_WARNING, MAP_WARNING, "specifying both a name and alignment to 'pop' is undefined"),
