...
import static jlang.clex.Token.TokenFlags.NeedsCleaning;
import static jlang.clex.Token.TokenFlags.StartOfLine;
import static jlang.clex.Lexer.WhiteSpacesKind.*;
            ...
            case '#':
                ...
                else
                {
                    ...
                    if (result.isAtStartOfLine() && !lexingRawMode && !isPragmaLexer)
                    {
                        ...
                        if (pp.isCurrentLexer(this))
                        {
                            // Star a new token.  If this is a #include or something, the PP may
