...
public class IdentifierInfo implements Cloneable {
  ...
  public PPKeyWordKind getPPKeywordID() {
    ...
    switch (name) {
      default:
        return PPKeyWordKind.pp_not_keyword;
      case "if":
        return PPKeyWordKind.pp_if;
      case "elif":
        return PPKeyWordKind.pp_elif;
      case "else":
        return PPKeyWordKind.pp_else;
      case "line":
        return PPKeyWordKind.pp_line;
      case "endif":
        return PPKeyWordKind.pp_endif;
      case "error":
        return PPKeyWordKind.pp_error;
      case "ifdef":
        return PPKeyWordKind.pp_ifdef;
      case "undef":
        return PPKeyWordKind.pp_undef;

      case "define":
        return PPKeyWordKind.pp_define;
      case "ifndef":
        return PPKeyWordKind.pp_ifndef;
      case "pragma":
        return PPKeyWordKind.pp_pragma;
      case "defined":
        return PPKeyWordKind.pp_defined;
      case "include":
        return PPKeyWordKind.pp_include;
      case "__include_macros":
        return PPKeyWordKind.pp___include_macros;
    }
  }
