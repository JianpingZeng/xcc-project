...
public enum DiagnosticSemaKinds implements DiagnosticSemaTag {
  ...
  EXT_ANON_PARAM_REQUIRES_TYPE_SPECIFIER(ext_anon_param_requires_type_specifier, CLASS_WARNING, MAP_IGNORE, "type specifier required for unnamed parameter, defaults to int"),
  ...
  EXT_MISSING_DECLSPEC(ext_missing_declspec, CLASS_WARNING, MAP_WARNING, "declaration specifier missing, defaulting to 'int'"),
  EXT_MISSING_TYPE_SPECIFIER(ext_missing_type_specifier, CLASS_WARNING, MAP_WARNING, "type specifier missing, defaults to 'int'"),
  ...
  EXT_RETURN_MISSING_EXPR(ext_return_missing_expr, CLASS_WARNING, MAP_WARNING, "non-void %select{function|method}1 %0 should return a value"),
  ...
  EXT_TYPECHECK_BASE_SUPER(ext_typecheck_base_super, CLASS_WARNING, MAP_WARNING, "method parameter type %0 does not match super class method parameter type %1"),
  ...
  EXT_TYPECHECK_COMPARISON_OF_DISTINCT_POINTERS(ext_typecheck_comparison_of_distinct_pointers, CLASS_WARNING, MAP_WARNING, "comparison of distinct pointer types (%0 and %1)"),
  EXT_TYPECHECK_COMPARISON_OF_FPTR_TO_VOID(ext_typecheck_comparison_of_fptr_to_void, CLASS_WARNING, MAP_WARNING, "equality comparison between function pointer and void pointer (%0 and %1)"),
  EXT_TYPECHECK_COMPARISON_OF_POINTER_INTEGER(ext_typecheck_comparison_of_pointer_integer, CLASS_WARNING, MAP_WARNING, "comparison between pointer and integer (%0 and %1)"),
  EXT_TYPECHECK_COND_INCOMPATIBLE_OPERANDS(ext_typecheck_cond_incompatible_operands, CLASS_WARNING, MAP_WARNING, "incompatible operand types (%0 and %1)"),
  ...
  EXT_TYPECHECK_CONVERT_DISCARDS_QUALIFIERS(ext_typecheck_convert_discards_qualifiers, CLASS_WARNING, MAP_WARNING, "%2 %1 discards qualifiers, expected %0"),
  EXT_TYPECHECK_CONVERT_INCOMPATIBLE_POINTER(ext_typecheck_convert_incompatible_pointer, CLASS_WARNING, MAP_WARNING, "incompatible pointer types %2 %1, expected %0"),
  EXT_TYPECHECK_CONVERT_INCOMPATIBLE_POINTER_SIGN(ext_typecheck_convert_incompatible_pointer_sign, CLASS_WARNING, MAP_WARNING, "pointer types point to integer types with different sign %2 %1, expected %0"),
  EXT_TYPECHECK_CONVERT_INT_POINTER(ext_typecheck_convert_int_pointer, CLASS_WARNING, MAP_WARNING, "incompatible integer to pointer conversion %2 %1, expected %0"),
  EXT_TYPECHECK_CONVERT_POINTER_INT(ext_typecheck_convert_pointer_int, CLASS_WARNING, MAP_WARNING, "incompatible pointer to integer conversion %2 %1, expected %0"),
  ...
  EXT_TYPECHECK_DECL_INCOMPLETE_TYPE(ext_typecheck_decl_incomplete_type, CLASS_WARNING, MAP_WARNING, "tentative definition of variable with internal linkage has incomplete non-array type %0"),
  ...
  EXT_TYPECHECK_ORDERED_COMPARISON_OF_FUNCTION_POINTERS(ext_typecheck_ordered_comparison_of_function_pointers, CLASS_WARNING, MAP_WARNING, "ordered comparison of function pointers (%0 and %1)"),
  EXT_TYPECHECK_ORDERED_COMPARISON_OF_POINTER_AND_ZERO(ext_typecheck_ordered_comparison_of_pointer_and_zero, CLASS_WARNING, MAP_WARNING, "ordered comparison between pointer and zero (%0 and %1) is an extension"),
  EXT_TYPECHECK_ORDERED_COMPARISON_OF_POINTER_INTEGER(ext_typecheck_ordered_comparison_of_pointer_integer, CLASS_WARNING, MAP_WARNING, "ordered comparison between pointer and integer (%0 and %1)"),
  EXT_TYPECHECK_ZERO_ARRAY_SIZE(ext_typecheck_zero_array_size, CLASS_NOTE, MAP_IGNORE, "zero size arrays are an extension"),
  EXT_TYPEDEF_WITHOUT_A_NAME(ext_typedef_without_a_name, CLASS_WARNING, MAP_WARNING, "typedef requires a asmName"),
  ...
  EXT_VARIABLE_SIZED_TYPE_IN_STRUCT(ext_variable_sized_type_in_struct, CLASS_WARNING, MAP_WARNING, "field %0 with variable sized type %1 not at the end of a struct or class is a GNU extension"),
