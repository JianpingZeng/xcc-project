...
import static cfe.diag.Diagnostic.ArgumentKind.*;
import static cfe.diag.Diagnostic.ExtensionHandling.Ext_Error;
import static cfe.diag.Diagnostic.ExtensionHandling.Ext_Ignore;
...
public final class Diagnostic {
  ...
  private Diagnostic.Level getDiagnosticLevel(int diagID, DiagnosticClass diagClass) {
    ...
    switch (Mapping.values()[mappingInfo.ordinal() & 7]) {
      default:
        Util.assertion(false, "Undefined diagMapping!");
      case MAP_IGNORE:
