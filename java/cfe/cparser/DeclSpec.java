...
import static cfe.cparser.DeclSpec.ParsedSpecifiers.*;
import static cfe.cparser.DeclSpec.SCS.*;
import static cfe.cparser.DeclSpec.TQ.TQ_unspecified;
import static cfe.cparser.DeclSpec.TSC.TSC_unspecified;
import static cfe.cparser.DeclSpec.TSS.TSS_unspecified;
...
public class DeclSpec implements DiagnosticSemaTag, DiagnosticParseTag {
  ...
  public SCS getStorageClassSpec() {
  ...
  // jlang.type-specifier
  public TSW getTypeSpecWidth() {
    return typeSpecWidth;
  }

  public TSC getTypeSpecComplex() {
    return typeSpecComplex;
  }

  public TSS getTypeSpecSign() {
    return typeSpecSign;
  }

  public TST getTypeSpecType() {
    return typeSpecType;
  }
  ...
  public boolean isInlineSpecifier() {
