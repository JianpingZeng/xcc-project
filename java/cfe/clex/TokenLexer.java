...
import static cfe.clex.Token.TokenFlags.LeadingSpace;
import static cfe.clex.Token.TokenFlags.StartOfLine;
  ...
  private void expandFunctionArguments() {
    ...
    for (int i = 0; i < tokens.length; i++) {
      ...
      if (numToks != 0) {
        ...
        // assembler-with-clex mode, invalid pastes are allowed through: in this
