...
import cfe.clex.PPCallBack.FileChangeReason;
import cfe.clex.PragmaHandler.*;
import cfe.clex.Preprocessor.DefinedTracker.TrackerState;
import cfe.diag.Diagnostic;
import cfe.diag.FixItHint;
...
import static cfe.clex.PPCallBack.FileChangeReason.RenameFile;
import static cfe.clex.PPCallBack.FileChangeReason.SystemHeaderPragma;
import static cfe.clex.Preprocessor.DefinedTracker.TrackerState.DefinedMacro;
import static cfe.clex.Preprocessor.DefinedTracker.TrackerState.NotDefMacro;
import static cfe.clex.Token.TokenFlags.*;
import static cfe.clex.TokenKind.*;
import static cfe.diag.DiagnosticCommonKindsTag.*;
import static cfe.diag.DiagnosticLexKindsTag.*;
import static cfe.support.CharacteristicKind.C_System;
import static cfe.support.CharacteristicKind.C_User;
...
public final class Preprocessor {
  ...
  private static boolean evaluateDirectiveSubExpr(
    ...
    while (true) {
      ...
      switch (operator) {
        default:
          Util.assertion(false, "Undefined operator token!");
        case percent:
          if (!rhs.val.eq(0))
