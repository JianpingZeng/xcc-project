...
import cfe.basic.Context;
import cfe.basic.SourceManager;
import cfe.basic.TargetInfo;
import cfe.basic.TargetInfo.IntType;
import cfe.clex.IdentifierTable;
...
import static cfe.sema.ASTContext.FloatingRank.*;
import static cfe.sema.ASTContext.GetBuiltinTypeError.*;
import static cfe.type.ArrayType.ArraySizeModifier.Normal;
import static cfe.type.TypeClass.Bool;
import static cfe.type.TypeClass.Char_S;
import static cfe.type.TypeClass.Char_U;
import static cfe.type.TypeClass.ConstantArray;
import static cfe.type.TypeClass.ConstantArrayWithExpr;
import static cfe.type.TypeClass.ConstantArrayWithoutExpr;
import static cfe.type.TypeClass.Double;
import static cfe.type.TypeClass.Enum;
import static cfe.type.TypeClass.Float;
import static cfe.type.TypeClass.FunctionProto;
import static cfe.type.TypeClass.IncompleteArray;
import static cfe.type.TypeClass.Int;
import static cfe.type.TypeClass.Int128;
import static cfe.type.TypeClass.Long;
import static cfe.type.TypeClass.LongDouble;
import static cfe.type.TypeClass.LongLong;
import static cfe.type.TypeClass.Pointer;
import static cfe.type.TypeClass.SChar;
import static cfe.type.TypeClass.Short;
import static cfe.type.TypeClass.Struct;
import static cfe.type.TypeClass.TypeDef;
import static cfe.type.TypeClass.UChar;
import static cfe.type.TypeClass.UInt;
import static cfe.type.TypeClass.UInt128;
import static cfe.type.TypeClass.ULong;
import static cfe.type.TypeClass.ULongLong;
import static cfe.type.TypeClass.UShort;
import static cfe.type.TypeClass.Union;
import static cfe.type.TypeClass.VariableArray;
import static cfe.type.TypeClass.Void;
...
public final class ASTContext {
  ...
  static FloatingRank getFloatingRank(QualType ty, ASTContext ctx) {
    ...
    switch (ty.getTypeClass()) {
      default:
        Util.shouldNotReachHere("getFloatingRank(): not a floating type");
      case TypeClass.Float:
        return FloatRank;
      case TypeClass.Double:
        return DoubleRank;
      case TypeClass.LongDouble:
  ...
  public int getIntegerRank(Type T) {
    ...
    switch (T.getTypeClass()) {
      default:
        Util.shouldNotReachHere("getIntegerRank(): not a built-in integer");
      case TypeClass.Bool:
  ...
  public FltSemantics getFloatTypeSemantics(QualType ty) {
    ...
    switch (pty.getTypeClass()) {
      default:
        Util.assertion(false, "Not a floating point type!");
      case Float:
