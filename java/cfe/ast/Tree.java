...
import static cfe.ast.Tree.Expr.IsLvalueResult.*;
import static cfe.ast.Tree.Expr.IsModifiableLvalueResult.*;
...
public abstract class Tree implements StmtClass {
  ...
  public static class TopLevel extends Tree {
    ...
    public void setDecls(ArrayList<DeclStmt> decls) {
      this.decls = decls;
    }
    ...
    public boolean isConstantInitializer(ASTContext context) {
      switch (stmtClass) {
        ...
        case InitListExprClass: {
          ...
          // to bitfields.
          cfe.ast.Tree.InitListExpr expr = (Tree.InitListExpr) this;
  ...
  public static class StringLiteral extends Expr {
    ...
    public void setStrData(String newStrData) {
      this.strData = newStrData;
    }
  ...
  public static class MemberExpr extends Expr {
    ...
    public void setMemberDecl(ValueDecl d) {
      memberDecl = d;
    }
  ...
  public static class BinaryExpr extends Expr {
    ...
    public void setOperatorLoc(SourceLocation loc) {
      oploc = loc;
    }

    public BinaryOperatorKind getOpcode() {
      return opcode;
    }
  ...
  public static class CompoundAssignExpr extends BinaryExpr {
     ...
     * @return
     */
    public QualType getComputationLHSType() {
    ...
    public QualType getComputationResultType() {
