...
public class X86_32ABIInfo implements ABIInfo {
  ...
  private static cfe.type.Type isSingleElementStruct(QualType ty, ASTContext ctx) {
    RecordType rt = ty.getAsStructureType();
    if (rt == null)
      return null;
  ...
  private ABIArgInfo classifyReturnType(QualType retType, LLVMContext ctx) {
    if (retType.isVoidType())
      ...
      cfe.type.Type seltTy = isSingleElementStruct(retType, context);
      if (seltTy != null) {
