...
public class Canonicalizer implements InstVisitor
{
	...
	private void handleOp2(BinaryOps inst)
	{
		Value x = inst.x;
		Value y = inst.y;
	 ...
	 * @param inst
	 *
	private void moveConstantToRight(BinaryOps inst)
	{
	...
	private void reduceIf(IfOp inst)
	{
		...
		{
			// skips the backend.transform for flort/double
			// due to NaN issue.
