        ...
        X86RegNames
{
	...
	{
		new TargetInstrDescriptor(PHI, "PHI", -1, TID.M_PSEUDO_FLAG, X86II.NoArg, null, null),
		new TargetInstrDescriptor(NOOP, "nop", -1, TID.M_PSEUDO_FLAG, X86II.RawFrm|X86II.NoArg, null, null),
		new TargetInstrDescriptor(ADJCALLSTACKDOWN, "ADJCALLSTACKDOWN", 1, TID.M_PSEUDO_FLAG, X86II.NoArg, ImplicitList2, ImplicitList3),
		new TargetInstrDescriptor(ADJCALLSTACKUP, "ADJCALLSTACKUP", 2, TID.M_PSEUDO_FLAG, X86II.NoArg, ImplicitList2, ImplicitList3),
		new TargetInstrDescriptor(IMPLICIT_USE, "IMPLICIT_USE", -1, TID.M_PSEUDO_FLAG, 0, null, null),
		new TargetInstrDescriptor(IMPLICIT_DEF, "IMPLICIT_DEF", -1, TID.M_PSEUDO_FLAG, 0, null, null),

		new TargetInstrDescriptor(RET, "ret", 0, TID.M_RET_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, null, null),

		new TargetInstrDescriptor(JMP, "jmp", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, null, null),
		new TargetInstrDescriptor(JB, "jb", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JAE, "jae", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JE, "je", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JNE, "jne", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JBE, "jbe", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JA, "ja", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JS, "js", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JNS, "jns", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JL, "jl", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JGE, "jge", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JLE, "jle", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),
		new TargetInstrDescriptor(JG, "jg", 1, TID.M_BRANCH_FLAG| TID.M_TERMINATOR_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, null),

		new TargetInstrDescriptor(CALLpcrel32, "call", 1, TID.M_CALL_FLAG, X86II.RawFrm|X86II.NoArg, ImplicitList1, ImplicitList9),
		new TargetInstrDescriptor(CALLr32, "call", 1, TID.M_CALL_FLAG, X86II.MRMS2r|X86II.Arg32, ImplicitList2, ImplicitList9),
		new TargetInstrDescriptor(CALLm32, "call", 1, TID.M_LOAD_FLAG, X86II.MRMS2m|X86II.Arg32, ImplicitList2, ImplicitList9),
		new TargetInstrDescriptor(LEAVE, "leave", 0, TID.M_LOAD_FLAG, X86II.RawFrm|X86II.Arg32, ImplicitList10, ImplicitList10),

		new TargetInstrDescriptor(BSWAPr32, "bswap", 2, TID.M_2_ADDR_FLAG, X86II.AddRegFrm|X86II.Arg32, null, null),
		...
		new TargetInstrDescriptor(NEGr8, "neg", 2, TID.M_2_ADDR_FLAG, X86II.MRMS3r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(NEGr16, "neg", 2, TID.M_2_ADDR_FLAG, X86II.MRMS3r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(NEGr32, "neg", 2, TID.M_2_ADDR_FLAG, X86II.MRMS3r|X86II.Arg32, null, ImplicitList1),

		new TargetInstrDescriptor(NOTr8, "not", 2, TID.M_2_ADDR_FLAG, X86II.MRMS2r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(NOTr16, "not", 2, TID.M_2_ADDR_FLAG, X86II.MRMS2r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(NOTr32, "not", 2, TID.M_2_ADDR_FLAG, X86II.MRMS2r|X86II.Arg32, null, ImplicitList1),

		new TargetInstrDescriptor(INCr8, "inc", 2, TID.M_2_ADDR_FLAG, X86II.MRMS0r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(INCr16, "inc", 2, TID.M_2_ADDR_FLAG, X86II.MRMS0r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(INCr32, "inc", 2, TID.M_2_ADDR_FLAG, X86II.MRMS0r|X86II.Arg32, null, ImplicitList1),

		new TargetInstrDescriptor(DECr8, "dec", 2, TID.M_2_ADDR_FLAG, X86II.MRMS1r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(DECr16, "dec", 2, TID.M_2_ADDR_FLAG, X86II.MRMS1r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(DECr32, "dec", 2, TID.M_2_ADDR_FLAG, X86II.MRMS1r|X86II.Arg32, null, ImplicitList1),

		new TargetInstrDescriptor(ADDrr8, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ADDrr16, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(ADDrr32, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(ADDri8, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS0r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ADDri16, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS0r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(ADDri32, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS0r|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(ADDri16b, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS0r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ADDri32b, "add", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS0r|X86II.Arg8, null, ImplicitList1),

		new TargetInstrDescriptor(ADCrr32, "adc", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg32, ImplicitList1, ImplicitList1),

		new TargetInstrDescriptor(SUBrr8, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(SUBrr16, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(SUBrr32, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg32, null, ImplicitList1),

		new TargetInstrDescriptor(SUBri8, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS5r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(SUBri16, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS5r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(SUBri32, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS5r|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(SUBri16b, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS5r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(SUBri32b, "sub", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMS5r|X86II.Arg8, null, ImplicitList1),

		new TargetInstrDescriptor(SBBrr32, "sbb", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMDestReg|X86II.Arg32, ImplicitList1, ImplicitList1),

		new TargetInstrDescriptor(IMULrr16, "imul", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMSrcReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(IMULrr32, "imul", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMSrcReg|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(IMULri16, "imul", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMSrcReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(IMULri32, "imul", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMSrcReg|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(IMULri16b, "imul", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMSrcReg|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(IMULri32b, "imul", 3, TID.M_2_ADDR_FLAG| TID.M_ARITH_FLAG, X86II.MRMSrcReg|X86II.Arg8, null, ImplicitList1),

		new TargetInstrDescriptor(ANDrr8, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ANDrr16, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(ANDrr32, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(ANDri8, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS4r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ANDri16, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS4r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(ANDri32, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS4r|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(ANDri16b, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS4r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ANDri32b, "and", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS4r|X86II.Arg8, null, ImplicitList1),

		new TargetInstrDescriptor(ORrr8, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ORrr16, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(ORrr32, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(ORri8, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS1r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ORri16, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS1r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(ORri32, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS1r|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(ORri16b, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS1r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(ORri32b, "or", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS1r|X86II.Arg8, null, ImplicitList1),

		new TargetInstrDescriptor(XORrr8, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(XORrr16, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(XORrr32, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMDestReg|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(XORri8, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS6r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(XORri16, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS6r|X86II.Arg16, null, ImplicitList1),
		new TargetInstrDescriptor(XORri32, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS6r|X86II.Arg32, null, ImplicitList1),
		new TargetInstrDescriptor(XORri16b, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS6r|X86II.Arg8, null, ImplicitList1),
		new TargetInstrDescriptor(XORri32b, "xor", 3, TID.M_2_ADDR_FLAG| TID.M_LOGICAL_FLAG, X86II.MRMS6r|X86II.Arg8, null, ImplicitList1),
