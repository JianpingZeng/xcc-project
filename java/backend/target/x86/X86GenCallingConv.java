...
public class X86GenCallingConv
{
    public static CCAssignFn CC_X86_Win64_C = (valNo, valVT, locVT, locInfo, argFlags, state) ->
    {
        ...
        if (locVT.equals(new EVT(MVT.v16i8)) || locVT.equals(new EVT(MVT.v8i16))
                || locVT.equals(new EVT(MVT.v4i32)) || locVT
                .equals(new EVT(MVT.v2i64)) || locVT.equals(new EVT(MVT.v4f32))
        ...
        if (locVT.equals(new EVT(MVT.v8i8)) || locVT.equals(new EVT(MVT.v4i16))
                || locVT.equals(new EVT(MVT.v2i32)) || locVT
                .equals(new EVT(MVT.v1i64)) || locVT.equals(new EVT(MVT.v2f32)))
        {
            locVT = new EVT(MVT.i64);
        ...
        if (locVT.equals(new EVT(MVT.f32)) || locVT.equals(new EVT(MVT.f64))
                || locVT.equals(new EVT(MVT.v16i8)) || locVT
                .equals(new EVT(MVT.v8i16)) || locVT.equals(new EVT(MVT.v4i32))
                || locVT.equals(new EVT(MVT.v2i64)) || locVT
                .equals(new EVT(MVT.v4f32)) || locVT.equals(new EVT(MVT.v2f64)))
        {
        ...
        if (locVT.equals(new EVT(MVT.i32)) || locVT.equals(new EVT(MVT.i64))
                || locVT.equals(new EVT(MVT.f32)) || locVT
                .equals(new EVT(MVT.f64)))
        {
        ...
        if (locVT.equals(new EVT(MVT.f80)))
        {
            int offset8 = state.allocateStack(
                    (int) state.getTarget().getTargetData()
    ...
    public static CCAssignFn CC_X86_64_C = (valNo, valVT, locVT, locInfo, argFlags, state) ->
    {
        ...
        if (locVT.equals(new EVT(MVT.i32)))
        {
            int[] regList1 = { EDI, ESI, EDX, ECX, R8D, R9D };
        ...
        if (locVT.equals(new EVT(MVT.i64)))
        {
            int[] regList2 = { RDI, RSI, RDX, RCX, R8, R9 };
                ...
                .equals(new EVT(MVT.v4f32)) || locVT.equals(new EVT(MVT.v2f64)))
        {
            ...
            {
                int[] regList3 = { XMM0, XMM1, XMM2, XMM3, XMM4, XMM5, XMM6,
                        XMM7 };
                ...
                || locVT.equals(new EVT(MVT.v2f64)))
        {
            ...
            state.addLoc(
                    CCValAssign.getMem(valNo, valVT, offset6, locVT, locInfo));
            return false;
        }
    ...
    public static CCAssignFn RetCC_X86_32_Fast = (valNo, valVT, locVT, locInfo, argFlags, state) ->
    {
        ...
        if (!RetCC_X86Common
                .apply(valNo, valVT, locVT, locInfo, argFlags, state))
            return false;
    ...
    public static CCAssignFn RetCC_X86_32_C = (valNo, valVT, locVT, locInfo, argFlags, state) ->
    {
        ...
        if (argFlags.isInReg())
        {
            if (((X86TargetMachine) state.getTarget()).getSubtarget().hasSSE2())
            {
                if (locVT.equals(new EVT(MVT.f32)) || locVT
                        .equals(new EVT(MVT.f64)))
                {
                    int[] regList1 = { XMM0, XMM1, XMM2 };
                    int reg = state.allocateReg(regList1);
    ...
    public static CCAssignFn CC_X86_32_Common = (valNo, valVT, locVT, locInfo, argFlags, state) ->
    {
        ...
        if (!state.isVarArg())
        {
            if (locVT.equals(new EVT(MVT.v8i8)) || locVT
                    .equals(new EVT(MVT.v4i16)) || locVT
                    .equals(new EVT(MVT.v2i32)) || locVT
                    .equals(new EVT(MVT.v2f32)))
            {
                int[] regList2 = { MM0, MM1, MM2 };
                int reg = state.allocateReg(regList2);
                if (reg != 0)
                {
                    state.addLoc(CCValAssign
        ...
        if (locVT.equals(new EVT(MVT.i32)) || locVT.equals(new EVT(MVT.f32)))
        {
        ...
        if (locVT.equals(new EVT(MVT.f80)))
        {
            int offset5 = state.allocateStack(
                    (int) state.getTarget().getTargetData()
                            .getTypeAllocSize(locVT.getTypeForEVT()), 4);
            state.addLoc(
                    CCValAssign.getMem(valNo, valVT, offset5, locVT, locInfo));
            return false;
        }
        ...
        if (!state.isVarArg())
        {
            if (locVT.equals(new EVT(MVT.v16i8)) || locVT
                    .equals(new EVT(MVT.v8i16)) || locVT
                    .equals(new EVT(MVT.v4i32)) || locVT
                    .equals(new EVT(MVT.v2i64)) || locVT
                    .equals(new EVT(MVT.v4f32)) || locVT
                    .equals(new EVT(MVT.v2f64)))
            {
                int[] regList6 = { XMM0, XMM1, XMM2, XMM3 };
                int reg = state.allocateReg(regList6);
                if (reg != 0)
                {
                    state.addLoc(CCValAssign
