...
public interface X86II
{
	...
	int MRM0r = 16;  int MRM1r = 17;  int MRM2r = 18;  int MRM3r = 19; // Format /0 /1 /2 /3
	int MRM4r = 20;  int MRM5r = 21;  int MRM6r = 22;  int MRM7r = 23; // Format /4 /5 /6 /7

	// Next, instructions that operate on a memory r/m operand...
	int MRM0m = 24;  int MRM1m = 25;  int MRM2m = 26;  int MRM3m = 27; // Format /0 /1 /2 /3
	int MRM4m = 28;  int MRM5m = 29;  int MRM6m = 30;  int MRM7m = 31; // Format /4 /5 /6 /7
	...
	int D8 = 3 << Op0Shift;   int D9 = 4 << Op0Shift;
	int DA = 5 << Op0Shift;   int DB = 6 << Op0Shift;
	int DC = 7 << Op0Shift;   int DD = 8 << Op0Shift;
	int DE = 9 << Op0Shift;   int DF = 10 << Op0Shift;
