	...
	public void dumpAll(ScheduleDAG dag)
	{
		...
		if (!preds.isEmpty())
		{
			...
			for (SDep d : preds)
			{
				...
				switch(d.getDepKind())
				{
					case Data:   System.err.print("val   "); break;
					case Anti:   System.err.print("anti  "); break;
					case Output: System.err.print("output"); break;
					case Order:  System.err.print("ch    "); break;
				}
				System.err.print("#");				
