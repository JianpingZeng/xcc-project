...
public final class AliasSetTracker
{
    ...
    */
    ...
    public boolean add(Instruction inst)
    {
        ...
        {
            case Load: add((LoadInst)inst);
            case Store: add((StoreInst)inst);
            case Call: add((CallInst)inst);
            default: return true;
        }
    }
    ...
    public static final class AliasSet
    {
        ...
        public void print(OutputStream os)
        {
            try(PrintWriter pw = new PrintWriter(os))
            {
                ...
                switch (accessTy)
                {
                    case NoModRef: pw.print("No access");
                    case Refs:      pw.print("Ref      ");
                    case Mods:      pw.print("Mod      ");
                    case ModRef:    pw.print("Mod/Ref  ");
                    default:
