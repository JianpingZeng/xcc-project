...
public abstract class RecTy
{
    ...
    public Init convertValue( UnsetInit ui) { return null; }
    public Init convertValue(   BitInit bi) { return null; }
    public Init convertValue(  BitsInit bi) { return null; }
    public Init convertValue(   IntInit ii) { return null; }
    public Init convertValue(StringInit si) { return null; }
    public Init convertValue(  ListInit li) { return null; }
    public Init convertValue( BinOpInit ui) { return null; }
    public Init convertValue(  CodeInit ci) { return null; }
    public Init convertValue(VarBitInit vb) { return null; }
    public Init convertValue(   DefInit di) { return null; }
    public Init convertValue(   DagInit di) { return null; }
    public Init convertValue( TypedInit ti) { return null; }
    ...
    public boolean baseClassOf( BitRecTy    rhs)  { return false; }
    public boolean baseClassOf( BitsRecTy   rhs)  { return false; }
    public boolean baseClassOf( IntRecTy    rhs)  { return false; }
    public boolean baseClassOf( StringRecTy rhs)  { return false; }
    public boolean baseClassOf( ListRecTy   rhs)  { return false; }
    public boolean baseClassOf( CodeRecTy   rhs)  { return false; }
    public boolean baseClassOf( DagRecTy    rhs)  { return false; }
    public boolean baseClassOf( RecordRecTy rhs)  { return false; }


    public static class BitRecTy extends RecTy
    {
        @Override
        public Init convertValue( UnsetInit ui) { return ui; }
        @Override
        public Init convertValue(   BitInit bi) { return bi; }
        @Override
        ...
        public Init convertValue(  CodeInit ci) { return null; }
        @Override
        public Init convertValue(VarBitInit vb) { return vb; }
        @Override
        public Init convertValue(   DefInit di) { return null; }
        @Override
        public Init convertValue(   DagInit di) { return null; }
        ...
        @Override
        public boolean baseClassOf( BitRecTy    rhs)  { return true; }
        @Override
        ...
        @Override
        public boolean baseClassOf( IntRecTy    rhs)  { return true;}
        @Override
        public boolean baseClassOf( StringRecTy rhs)  { return false; }
        @Override
        public boolean baseClassOf( ListRecTy   rhs)  { return false; }
    ...
    public static class BitsRecTy extends RecTy
    {
        ...
        public BitsRecTy(int sz) {size = sz;}

        public int getNumBits() {return size;}
        ...
        @Override
        public boolean baseClassOf( BitRecTy    rhs)  { return size == 1; }
        @Override
        public boolean baseClassOf( BitsRecTy   rhs)  { return size == rhs.size; }
        @Override
        public boolean baseClassOf( IntRecTy    rhs)  { return true;}
        @Override
        public boolean baseClassOf( StringRecTy rhs)  { return false; }
    ...
    public static class IntRecTy extends RecTy
    {
        ...
        @Override
        public Init convertValue(   IntInit ii) { return ii;   }
        @Override
        public Init convertValue(StringInit si) { return null; }
        @Override
        public Init convertValue(  ListInit li) { return null; }
        ...
        public boolean baseClassOf( BitRecTy    rhs)  { return true; }
        @Override
        public boolean baseClassOf( BitsRecTy   rhs)  { return true; }
        @Override
        public boolean baseClassOf( IntRecTy    rhs)  { return true; }
        @Override
        public boolean baseClassOf( StringRecTy rhs)  { return false; }
    ...
    public static class StringRecTy extends RecTy
    {
        ...
        public Init convertValue(   IntInit ii) {return null;}
        @Override
        public Init convertValue(StringInit si) { return si; }
        @Override
        public Init convertValue(  ListInit li) { return null; }
        @Override
        ...
        public boolean baseClassOf( IntRecTy    rhs)  { return false;}
        @Override
        public boolean baseClassOf( StringRecTy rhs)  { return true; }
        @Override
        public boolean baseClassOf( ListRecTy   rhs)  { return false; }
        @Override
        public boolean baseClassOf( CodeRecTy   rhs)  { return false; }
    ...
    public static class ListRecTy extends RecTy
    {
        ...
        public ListRecTy(RecTy eltTy) {ty = eltTy;}
    ...
    public static class CodeRecTy extends RecTy
    {
        ...
        public Init convertValue( BinOpInit ui) { return null; }
        @Override
        public Init convertValue(  CodeInit ci) { return ci; }
        @Override
        public Init convertValue(VarBitInit vb) { return null; }
        @Override
        public Init convertValue(   DefInit di) { return null; }
        ...
        public boolean baseClassOf( ListRecTy   rhs)  { return false; }
        @Override
        public boolean baseClassOf( CodeRecTy   rhs)  { return true;  }
        @Override
        public boolean baseClassOf( DagRecTy    rhs)  { return false; }
        @Override
        public boolean baseClassOf( RecordRecTy rhs)  { return false; }
    ...
    public static class DagRecTy extends RecTy
    {
        ...
        public Init convertValue(   DefInit di) { return null; }
        @Override
        public Init convertValue(   DagInit di) { return di; }
        @Override
        public Init convertValue( TypedInit ti)
        {
            if (ti.getType().typeIsConvertiableTo(this))
        ...
        public boolean baseClassOf( CodeRecTy   rhs)  { return false;  }
        @Override
        public boolean baseClassOf( DagRecTy    rhs)  { return true; }
        @Override
        public boolean baseClassOf( RecordRecTy rhs)  { return false; }
    }
