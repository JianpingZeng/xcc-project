...
public final class RegisterInfoEmitter extends TableGenBackend
{
    ...
    /**
     * Prints out all of register names as the variable asmName of integer type.
     ...
     * register asmName enumeration set.
     */
    ...
    private void generateValueTypeForRegClass(PrintStream os)
    {
        ...
        for (CodeGenRegisterClass rc : regClasses)
        {
            // Given the value type a legal Java asmName if it is anonymous.
    ...
    /**
     * Sorting predicate to sort record by asmName.
     */
    ...
    /**
     * Sorting predicate to sort the record by theire asmName field.
     */
