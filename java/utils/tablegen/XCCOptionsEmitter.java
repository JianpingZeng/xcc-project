 ...
 * @version 0.4
 */
public class XCCOptionsEmitter extends TableGenBackend {
  private RecordKeeper records;

  public XCCOptionsEmitter(RecordKeeper records) {
  ...
  private void emitOptionIDs(ArrayList<Record> options, PrintStream os) {
    emitSourceFileHeaderComment("OptionInfo ID definitions for XCCTool driver", os);

    os.printf("package driver;%n%n");
  ...
  private void emitOptionKind(ArrayList<Record> options, PrintStream os) {
    emitSourceFileHeaderComment("OptionInfo Kinds definitions for XCCTool driver", os);
  ...
  private void emitGroup(ArrayList<Record> groups, PrintStream os) {
    emitSourceFileHeaderComment("Group ID definitions for XCCTool driver", os);
  ...
  private void emitGroup2(ArrayList<Record> groups, PrintStream os) {
    emitSourceFileHeaderComment("Group definitions for XCCTool driver", os);

    os.printf("package driver;%n%n");
    os.println("import static driver.GroupID.*;");
  ...
  public void run(String outputFile) throws FileNotFoundException {
    ...
    try (PrintStream os = outputFile.equals("-") ?
      ...
      emitSourceFileHeaderComment("Options definitions for XCCTool driver", os);

      os.printf("package driver;%n%n");
      os.println("import static driver.OptionKind.*;");
      os.println("import static driver.OptionID.*;");
      os.println("import static driver.GroupID.*;");
      os.println("import static driver.XCCFlags.*;");
