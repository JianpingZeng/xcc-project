...
public final class TGLexer
{
    ...
    public void printError(MemoryBuffer loc, String msg)
    {
        printError(SMLoc.get(loc), msg);
    }

    public void printError(SMLoc loc, String msg)
    {
        sgr.printMessage(loc, msg, "error");
    }
    ...
    private TokKind lexIdentifier()
    {
        ...
        switch (id)
        {
            case "int": return TokKind.Int;
            case "bit": return TokKind.Bit;
            case "bits": return TokKind.Bits;
            case "string": return TokKind.String;
            case "list": return TokKind.List;
            case "code": return TokKind.Code;
            case "dag": return TokKind.Dag;
            case "class": return TokKind.Class;
            case "def": return TokKind.Def;
            case "defm": return TokKind.Defm;
            case "multiclass": return TokKind.Multiclass;
            case "field": return TokKind.Field;
            case "let": return TokKind.Let;
            case "in": return TokKind.In;
            case "include":
            {
    ...
    private TokKind lexExclaim()
    {
        ...
        switch (op)
        {
            case "con": return TokKind.XConcat;
            case "sra": return TokKind.XSRA;
            case "srl": return TokKind.XSRL;
            case "shl": return TokKind.XSHL;
            case "strconcat": return TokKind.XStrConcat;
            case "nameconcat": return TokKind.XNameConcat;
            case "subst": return TokKind.XSubst;
            case "foreach": return TokKind.XForEach;
            case "cast": return TokKind.XCast;
            case "car": return TokKind.XCar;
