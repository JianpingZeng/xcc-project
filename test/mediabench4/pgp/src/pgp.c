...
char rel_version[] = _LANG("2.6.2");	/* release version */
static char rel_date[] = "11 Oct 94";	/* release date */
...
#endif
    fprintf(stderr,
LANG("(c) 1990-1994 Philip Zimmermann, Phil's Pretty Good Software. %s\n"),
	    rel_date);
...
#if defined(UNIX) || defined(MSDOS) || defined(OS2)
