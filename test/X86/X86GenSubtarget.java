...
public final class X86GenSubtarget {

	public static final int Feature3DNow = 1 << 0;
	public static final int Feature3DNowA = 1 << 1;
	public static final int Feature64Bit = 1 << 2;
	public static final int FeatureAVX = 1 << 3;
	public static final int FeatureFMA3 = 1 << 4;
	public static final int FeatureFMA4 = 1 << 5;
	public static final int FeatureMMX = 1 << 6;
	public static final int FeatureSSE1 = 1 << 7;
	public static final int FeatureSSE2 = 1 << 8;
	public static final int FeatureSSE3 = 1 << 9;
	public static final int FeatureSSE41 = 1 << 10;
	public static final int FeatureSSE42 = 1 << 11;
	public static final int FeatureSSE4A = 1 << 12;
	public static final int FeatureSSSE3 = 1 << 13;
	public static final int FeatureSlowBTMem = 1 << 14
	 ...
	 */
	public static String parseSubtargetFeatures(String fs, String cpu) {
		SubtargetFeatures features = new SubtargetFeatures(fs);
		features.setCPUIfNone(cpu);
		int bits = features.getBits(subTypeKV,featureKV);
		if ((bits & Feature3DNow) != 0 && X863DNowLevel < ThreeDNow)
		...
		if ((bits & FeatureFMA4) != 0)
			HasFMA4 = true;
		if ((bits & FeatureMMX) != 0 && X86SSELevel < MMX)
			X86SSELevel = MMX;
		if ((bits & FeatureSSE1) != 0 && X86SSELevel < SSE1)
			X86SSELevel = SSE1;
		if ((bits & FeatureSSE2) != 0 && X86SSELevel < SSE2)
			X86SSELevel = SSE2;
		if ((bits & FeatureSSE3) != 0 && X86SSELevel < SSE3)
			X86SSELevel = SSE3;
		if ((bits & FeatureSSE41) != 0 && X86SSELevel < SSE41)
			X86SSELevel = SSE41;
		if ((bits & FeatureSSE42) != 0 && X86SSELevel < SSE42)
			X86SSELevel = SSE42;
		if ((bits & FeatureSSE4A) != 0)
			HasSSE4A = true;
		if ((bits & FeatureSSSE3) != 0 && X86SSELevel < SSSE3)
			X86SSELevel = SSSE3;
