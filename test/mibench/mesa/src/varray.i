...
void gl_ArrayElement( GLcontext *ctx, GLint i )
{
   ...
   if (ctx->Array.NormalEnabled) {
      ...
      switch (ctx->Array.NormalType) {
         case GL_BYTE:
            VB->Normal[count][0] = ((2.0F * (p[0]) + 1.0F) * (1.0F/255.0F));
            VB->Normal[count][1] = ((2.0F * (p[1]) + 1.0F) * (1.0F/255.0F));
            VB->Normal[count][2] = ((2.0F * (p[2]) + 1.0F) * (1.0F/255.0F));
            break;
         case GL_SHORT:
            VB->Normal[count][0] = ((2.0F * (((GLshort*)p)[0]) + 1.0F) * (1.0F/65535.0F));
            VB->Normal[count][1] = ((2.0F * (((GLshort*)p)[1]) + 1.0F) * (1.0F/65535.0F));
            VB->Normal[count][2] = ((2.0F * (((GLshort*)p)[2]) + 1.0F) * (1.0F/65535.0F));
            break;
         case GL_INT:
            VB->Normal[count][0] = ((2.0F * (((GLint*)p)[0]) + 1.0F) * (1.0F/4294967294.0F));
            VB->Normal[count][1] = ((2.0F * (((GLint*)p)[1]) + 1.0F) * (1.0F/4294967294.0F));
            VB->Normal[count][2] = ((2.0F * (((GLint*)p)[2]) + 1.0F) * (1.0F/4294967294.0F));
            break;
         case GL_FLOAT:
   ...
   if (ctx->Array.TexCoordEnabled) {
      ...
      VB->TexCoord[count][0] = ctx->Current.TexCoord[0]; VB->TexCoord[count][1] = ctx->Current.TexCoord[1]; VB->TexCoord[count][2] = ctx->Current.TexCoord[2]; VB->TexCoord[count][3] = ctx->Current.TexCoord[3];;
   }
                    ...
                    GLenum mode, GLint first, GLsizei count )
{
   ...
   if (!ctx->Light.Enabled
      ...
      while (remaining>0) {
         ...
         vbspace = 480 - VB->Start;
         n = ( (vbspace)<(remaining) ? (vbspace) : (remaining) );
...

         {
            ...
            for (i=0;i<n;i++) {
               VB->Fcolor[start+i][0] = r; VB->Fcolor[start+i][1] = g; VB->Fcolor[start+i][2] = b; VB->Fcolor[start+i][3] = a;;
            }
         }
