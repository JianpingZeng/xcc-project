     ...
     GLuint index[], GLenum primitive )
{
   GLuint i;
   GLubyte mask[1280];
   GLuint index_save[1280];


   for (i=0;i<n;i++)
      mask[i] = 1;

   if ((ctx->RasterMask & 0x200) || primitive==GL_BITMAP) {
  ...
  return;
   ...
   if (ctx->RasterMask & 0x400) {
      ...
      memcpy( (void *) (index_save), (void *) (index), (size_t) (n * sizeof(GLuint)) );
   }
   ...
   if (ctx->RasterMask & 0x400) {
      ...
      memcpy( (void *) (index), (void *) (index_save), (size_t) (n * sizeof(GLuint)) );
      if (ctx->Color.SWLogicOpEnabled) {
         gl_logicop_ci_span( ctx, n, x, y, index, mask );
      }
      if (ctx->Color.SWmasking) {
     ...
     GLenum primitive )
{
   ...
   GLubyte rtmp[1280], gtmp[1280], btmp[1280], atmp[1280];
  ...
  return;
   ...
   if ((primitive==GL_BITMAP && ctx->MutablePixels)
      ...
      memcpy( (void *) (rtmp), (void *) (r), (size_t) (n * sizeof(GLubyte)) );
      memcpy( (void *) (gtmp), (void *) (g), (size_t) (n * sizeof(GLubyte)) );
      memcpy( (void *) (btmp), (void *) (b), (size_t) (n * sizeof(GLubyte)) );
      memcpy( (void *) (atmp), (void *) (a), (size_t) (n * sizeof(GLubyte)) );
      red = rtmp;
      green = gtmp;
      blue = btmp;
      alpha = atmp;
       ...
       GLenum primitive )
{
  ...
  return;
   ...
   if (primitive==GL_BITMAP || (ctx->RasterMask & 0x400)) {
    ...
    GLubyte blue[], GLubyte alpha[] )
{
  ...
  n = ( (n)<(ctx->Buffer->Width - x) ? (n) : (ctx->Buffer->Width - x) );
