...
void gl_mask_color_span( GLcontext *ctx,
                         ...
                         GLubyte blue[], GLubyte alpha[] )
{
   GLubyte r[1280], g[1280], b[1280], a[1280];

   gl_read_color_span( ctx, n, x, y, r, g, b, a );

   if ((ctx->Color.ColorMask & 8) == 0) {

      memcpy( (void *) (red), (void *) (r), (size_t) (n) );
   }
   if ((ctx->Color.ColorMask & 4) == 0) {

      memcpy( (void *) (green), (void *) (g), (size_t) (n) );
   }
   if ((ctx->Color.ColorMask & 2) == 0) {

      memcpy( (void *) (blue), (void *) (b), (size_t) (n) );
   }
   if ((ctx->Color.ColorMask & 1) == 0) {

      memcpy( (void *) (alpha), (void *) (a), (size_t) (n) );
   }
}
...
void gl_mask_color_pixels( GLcontext *ctx,
                           ...
                           const GLubyte mask[] )
{
   GLubyte r[(3*1280)], g[(3*1280)], b[(3*1280)], a[(3*1280)];
