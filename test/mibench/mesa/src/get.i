...
void gl_GetBooleanv( GLcontext *ctx, GLenum pname, GLboolean *params )
{
   ...
   switch (pname) {
      ...
      case GL_ACCUM_ALPHA_BITS:
         *params = ( (sizeof(GLaccum)*8)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_ACCUM_CLEAR_VALUE:
         params[0] = ( (ctx->Accum.ClearColor[0])==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Accum.ClearColor[1])==0.0F ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Accum.ClearColor[2])==0.0F ? GL_FALSE : GL_TRUE );
         params[3] = ( (ctx->Accum.ClearColor[3])==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_ALPHA_BIAS:
         *params = ( (ctx->Pixel.AlphaBias)==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_ALPHA_BITS:
         ...
         break;
      case GL_ALPHA_SCALE:
         *params = ( (ctx->Pixel.AlphaScale)==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_ALPHA_TEST:
         *params = ctx->Color.AlphaEnabled;
         break;
      case GL_ALPHA_TEST_FUNC:
         *params = ( (ctx->Color.AlphaFunc)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_ALPHA_TEST_REF:
         *params = ( (ctx->Color.AlphaRef)==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_ATTRIB_STACK_DEPTH:
         *params = ( (ctx->AttribStackDepth)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_AUTO_NORMAL:
         *params = ctx->Eval.AutoNormal;
         break;
      case GL_AUX_BUFFERS:
         *params = (0) ? GL_TRUE : GL_FALSE;
         break;
      case GL_BLEND:
         *params = ctx->Color.BlendEnabled;
         break;
      case GL_BLEND_DST:
         *params = ( (ctx->Color.BlendDst)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_BLEND_SRC:
         *params = ( (ctx->Color.BlendSrc)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_BLEND_EQUATION_EXT:
  *params = ( (ctx->Color.BlendEquation)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_BLEND_COLOR_EXT:
  params[0] = ( (ctx->Color.BlendColor[0])==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Color.BlendColor[1])==0.0F ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Color.BlendColor[2])==0.0F ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Color.BlendColor[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_BLUE_BIAS:
         *params = ( (ctx->Pixel.BlueBias)==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_BLUE_BITS:
         *params = ( (bits( ctx->Visual->BlueScale ))==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_BLUE_SCALE:
         *params = ( (ctx->Pixel.BlueScale)==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_CLIENT_ATTRIB_STACK_DEPTH:
         *params = ( (ctx->ClientAttribStackDepth)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_CLIP_PLANE0:
      case GL_CLIP_PLANE1:
      case GL_CLIP_PLANE2:
      ...
      case GL_COLOR_CLEAR_VALUE:
         params[0] = ( (ctx->Color.ClearColor[0])==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Color.ClearColor[1])==0.0F ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Color.ClearColor[2])==0.0F ? GL_FALSE : GL_TRUE );
         params[3] = ( (ctx->Color.ClearColor[3])==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_COLOR_MATERIAL:
         *params = ctx->Light.ColorMaterialEnabled;
         break;
      case GL_COLOR_MATERIAL_FACE:
         *params = ( (ctx->Light.ColorMaterialFace)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_COLOR_MATERIAL_PARAMETER:
         *params = ( (ctx->Light.ColorMaterialMode)==0 ? GL_FALSE : GL_TRUE );
         break;
      ...
      case GL_CULL_FACE_MODE:
         *params = ( (ctx->Polygon.CullFaceMode)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_CURRENT_COLOR:
         params[0] = ( (ctx->Current.IntColor[0])==0 ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Current.IntColor[1])==0 ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Current.IntColor[2])==0 ? GL_FALSE : GL_TRUE );
         params[3] = ( (ctx->Current.IntColor[3])==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_CURRENT_INDEX:
         *params = ( (ctx->Current.Index)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_CURRENT_NORMAL:
         params[0] = ( (ctx->Current.Normal[0])==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Current.Normal[1])==0.0F ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Current.Normal[2])==0.0F ? GL_FALSE : GL_TRUE );
         break;
      case GL_CURRENT_RASTER_COLOR:
  params[0] = ( (ctx->Current.RasterColor[0])==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Current.RasterColor[1])==0.0F ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Current.RasterColor[2])==0.0F ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Current.RasterColor[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_CURRENT_RASTER_DISTANCE:
  *params = ( (ctx->Current.RasterDistance)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_CURRENT_RASTER_INDEX:
  *params = ( (ctx->Current.RasterIndex)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_CURRENT_RASTER_POSITION:
  params[0] = ( (ctx->Current.RasterPos[0])==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Current.RasterPos[1])==0.0F ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Current.RasterPos[2])==0.0F ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Current.RasterPos[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_CURRENT_RASTER_TEXTURE_COORDS:
         params[0] = ( (ctx->Current.RasterTexCoord[0])==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Current.RasterTexCoord[1])==0.0F ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Current.RasterTexCoord[2])==0.0F ? GL_FALSE : GL_TRUE );
         params[3] = ( (ctx->Current.RasterTexCoord[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_CURRENT_RASTER_POSITION_VALID:
         *params = ctx->Current.RasterPosValid;
  break;
      case GL_CURRENT_TEXTURE_COORDS:
         params[0] = ( (ctx->Current.TexCoord[0])==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Current.TexCoord[1])==0.0F ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Current.TexCoord[2])==0.0F ? GL_FALSE : GL_TRUE );
         params[3] = ( (ctx->Current.TexCoord[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_BIAS:
         *params = ( (ctx->Pixel.DepthBias)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_BITS:
  *params = ( (8*sizeof(GLdepth))==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_CLEAR_VALUE:
         *params = ( (ctx->Depth.Clear)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_FUNC:
         *params = ( (ctx->Depth.Func)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_RANGE:
         params[0] = ( (ctx->Viewport.Near)==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Viewport.Far)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_SCALE:
         *params = ( (ctx->Pixel.DepthScale)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_DEPTH_TEST:
  ...
  *params = ctx->Visual->DBflag;
  break;
      case GL_DRAW_BUFFER:
  *params = ( (ctx->Color.DrawBuffer)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_EDGE_FLAG:
  *params = ctx->Current.EdgeFlag;
  break;
      case GL_FEEDBACK_BUFFER_SIZE:
         ...
         *params = ( (ctx->Feedback.BufferSize)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_FEEDBACK_BUFFER_TYPE:
         *params = ( (ctx->Feedback.Type)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_FOG:
  *params = ctx->Fog.Enabled;
  break;
      case GL_FOG_COLOR:
         params[0] = ( (ctx->Fog.Color[0])==0.0F ? GL_FALSE : GL_TRUE );
         params[1] = ( (ctx->Fog.Color[1])==0.0F ? GL_FALSE : GL_TRUE );
         params[2] = ( (ctx->Fog.Color[2])==0.0F ? GL_FALSE : GL_TRUE );
         params[3] = ( (ctx->Fog.Color[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_FOG_DENSITY:
         *params = ( (ctx->Fog.Density)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_FOG_END:
         *params = ( (ctx->Fog.End)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_FOG_HINT:
  *params = ( (ctx->Hint.Fog)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_FOG_INDEX:
  *params = ( (ctx->Fog.Index)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_FOG_MODE:
  *params = ( (ctx->Fog.Mode)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_FOG_START:
         *params = ( (ctx->Fog.End)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_FRONT_FACE:
  *params = ( (ctx->Polygon.FrontFace)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_GREEN_BIAS:
         *params = ( (ctx->Pixel.GreenBias)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_GREEN_BITS:
         *params = ( (bits( ctx->Visual->GreenScale ))==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_GREEN_SCALE:
         *params = ( (ctx->Pixel.GreenScale)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_INDEX_BITS:
         *params = ( (ctx->Visual->IndexBits)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_INDEX_CLEAR_VALUE:
  *params = ( (ctx->Color.ClearIndex)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_INDEX_MODE:
  *params = ctx->Visual->RGBAflag ? GL_FALSE : GL_TRUE;
  break;
      case GL_INDEX_OFFSET:
  *params = ( (ctx->Pixel.IndexOffset)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_INDEX_SHIFT:
  *params = ( (ctx->Pixel.IndexShift)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_INDEX_WRITEMASK:
  *params = ( (ctx->Color.IndexMask)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_LIGHT0:
      case GL_LIGHT1:
      case GL_LIGHT2:
  ...
  *params = ctx->Light.Enabled;
  ...
  params[0] = ( (ctx->Light.Model.Ambient[0])==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Light.Model.Ambient[1])==0.0F ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Light.Model.Ambient[2])==0.0F ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Light.Model.Ambient[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
  ...
  *params = ( (ctx->Hint.LineSmooth)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_LINE_STIPPLE:
  *params = ctx->Line.StippleFlag;
  break;
      case GL_LINE_STIPPLE_PATTERN:
  *params = ( (ctx->Line.StipplePattern)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_LINE_STIPPLE_REPEAT:
  *params = ( (ctx->Line.StippleFactor)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_LINE_WIDTH:
  *params = ( (ctx->Line.Width)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_LINE_WIDTH_GRANULARITY:
  *params = ( (1.0)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_LINE_WIDTH_RANGE:
  params[0] = ( (1.0)==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (10.0)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_LIST_BASE:
  *params = ( (ctx->List.ListBase)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_LIST_INDEX:
  *params = ( (gl_list_index())==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_LIST_MODE:
  *params = ( (ctx->ExecuteFlag ? GL_COMPILE_AND_EXECUTE : GL_COMPILE)==0 ? GL_FALSE : GL_TRUE )
                                             ;
  break;
  ...
  *params = ( (ctx->Color.LogicOp)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAP1_COLOR_4:
  *params = ctx->Eval.Map1Color4;
  break;
      case GL_MAP1_GRID_DOMAIN:
  params[0] = ( (ctx->Eval.MapGrid1u1)==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Eval.MapGrid1u2)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAP1_GRID_SEGMENTS:
  *params = ( (ctx->Eval.MapGrid1un)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAP1_INDEX:
  ...
  *params = ctx->Eval.Map2Color4;
  ...
  params[0] = ( (ctx->Eval.MapGrid2u1)==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Eval.MapGrid2u2)==0.0F ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Eval.MapGrid2v1)==0.0F ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Eval.MapGrid2v2)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAP2_GRID_SEGMENTS:
  params[0] = ( (ctx->Eval.MapGrid2un)==0 ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Eval.MapGrid2vn)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAP2_INDEX:
  ...
  *params = ctx->Pixel.MapStencilFlag;
  break;
      case GL_MATRIX_MODE:
  *params = ( (ctx->Transform.MatrixMode)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_ATTRIB_STACK_DEPTH:
  *params = ( (16)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_CLIENT_ATTRIB_STACK_DEPTH:
         *params = ( (16)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_MAX_CLIP_PLANES:
  *params = ( (6)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_EVAL_ORDER:
  *params = ( (30)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_LIGHTS:
  *params = ( (8)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_LIST_NESTING:
  *params = ( (64)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_MODELVIEW_STACK_DEPTH:
  *params = ( (32)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_NAME_STACK_DEPTH:
  *params = ( (64)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_PIXEL_MAP_TABLE:
  *params = ( (256)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_PROJECTION_STACK_DEPTH:
  *params = ( (32)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_TEXTURE_SIZE:
  *params = ( ((1 << (11 -1)))==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_TEXTURE_STACK_DEPTH:
  *params = ( (10)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MAX_VIEWPORT_DIMS:
  params[0] = ( (1280)==0 ? GL_FALSE : GL_TRUE );
  params[1] = ( (1024)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_MODELVIEW_MATRIX:
  for (i=0;i<16;i++) {
     params[i] = ( (ctx->ModelViewMatrix[i])==0.0F ? GL_FALSE : GL_TRUE );
  }
  break;
      case GL_MODELVIEW_STACK_DEPTH:
  *params = ( (ctx->ModelViewStackDepth)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_NAME_STACK_DEPTH:
  *params = ( (ctx->Select.NameStackDepth)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_NORMALIZE:
  *params = ctx->Transform.Normalize;
  break;
      case GL_PACK_ALIGNMENT:
  *params = ( (ctx->Pack.Alignment)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PACK_LSB_FIRST:
  *params = ctx->Pack.LsbFirst;
  break;
      case GL_PACK_ROW_LENGTH:
  *params = ( (ctx->Pack.RowLength)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PACK_SKIP_PIXELS:
  *params = ( (ctx->Pack.SkipPixels)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PACK_SKIP_ROWS:
  *params = ( (ctx->Pack.SkipRows)==0 ? GL_FALSE : GL_TRUE );
  break;
  ...
  *params = ( (ctx->Hint.PerspectiveCorrection)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_A_TO_A_SIZE:
  *params = ( (ctx->Pixel.MapAtoAsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_B_TO_B_SIZE:
  *params = ( (ctx->Pixel.MapBtoBsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_G_TO_G_SIZE:
  *params = ( (ctx->Pixel.MapGtoGsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_I_TO_A_SIZE:
  *params = ( (ctx->Pixel.MapItoAsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_I_TO_B_SIZE:
  *params = ( (ctx->Pixel.MapItoBsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_I_TO_G_SIZE:
  *params = ( (ctx->Pixel.MapItoGsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_I_TO_I_SIZE:
  *params = ( (ctx->Pixel.MapItoIsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_I_TO_R_SIZE:
  *params = ( (ctx->Pixel.MapItoRsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_R_TO_R_SIZE:
  *params = ( (ctx->Pixel.MapRtoRsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_PIXEL_MAP_S_TO_S_SIZE:
  *params = ( (ctx->Pixel.MapStoSsize)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_POINT_SIZE:
  *params = ( (ctx->Point.Size)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_POINT_SIZE_GRANULARITY:
  *params = ( (0.1)==0.0F ? GL_FALSE : GL_TRUE );
  break;
  ...
  *params = ( (ctx->Hint.PointSmooth)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_POLYGON_MODE:
  params[0] = ( (ctx->Polygon.FrontMode)==0 ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Polygon.BackMode)==0 ? GL_FALSE : GL_TRUE );
  break;

      case GL_POLYGON_OFFSET_BIAS_EXT:
         *params = ( (ctx->Polygon.OffsetUnits)==0.0F ? GL_FALSE : GL_TRUE );
         break;

      case GL_POLYGON_OFFSET_FACTOR:
         *params = ( (ctx->Polygon.OffsetFactor)==0.0F ? GL_FALSE : GL_TRUE );
         break;
  ...
  *params = ( (ctx->Hint.PolygonSmooth)==0 ? GL_FALSE : GL_TRUE );
  break;
  ...
  *params = ctx->Polygon.StippleFlag;
  ...
  for (i=0;i<16;i++) {
     params[i] = ( (ctx->ProjectionMatrix[i])==0.0F ? GL_FALSE : GL_TRUE );
  }
  break;
      case GL_PROJECTION_STACK_DEPTH:
  *params = ( (ctx->ProjectionStackDepth)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_READ_BUFFER:
  *params = ( (ctx->Pixel.ReadBuffer)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_RED_BIAS:
         *params = ( (ctx->Pixel.RedBias)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_RED_BITS:
         *params = ( (bits( ctx->Visual->RedScale ))==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_RED_SCALE:
         *params = ( (ctx->Pixel.RedScale)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_RENDER_MODE:
  *params = ( (ctx->RenderMode)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_RGBA_MODE:
         *params = ctx->Visual->RGBAflag;
  break;
      case GL_SCISSOR_BOX:
  params[0] = ( (ctx->Scissor.X)==0 ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Scissor.Y)==0 ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Scissor.Width)==0 ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Scissor.Height)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_SCISSOR_TEST:
  *params = ctx->Scissor.Enabled;
  break;
      case GL_SHADE_MODEL:
  *params = ( (ctx->Light.ShadeModel)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_BITS:
  *params = ( (8*sizeof(GLstencil))==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_CLEAR_VALUE:
  *params = ( (ctx->Stencil.Clear)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_FAIL:
  *params = ( (ctx->Stencil.FailFunc)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_FUNC:
  *params = ( (ctx->Stencil.Function)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_PASS_DEPTH_FAIL:
  *params = ( (ctx->Stencil.ZFailFunc)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_PASS_DEPTH_PASS:
  *params = ( (ctx->Stencil.ZPassFunc)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_REF:
  *params = ( (ctx->Stencil.Ref)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_TEST:
  *params = ctx->Stencil.Enabled;
  break;
      case GL_STENCIL_VALUE_MASK:
  *params = ( (ctx->Stencil.ValueMask)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STENCIL_WRITEMASK:
  *params = ( (ctx->Stencil.WriteMask)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_STEREO:
  *params = GL_FALSE;
  break;
      case GL_SUBPIXEL_BITS:
  *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_TEXTURE_1D:
  *params = (ctx->Texture.Enabled & 1) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_2D:
  *params = (ctx->Texture.Enabled & 2) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_3D_EXT:
  *params = (ctx->Texture.Enabled & 4) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_ENV_COLOR:
  params[0] = ( (ctx->Texture.EnvColor[0])==0.0F ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Texture.EnvColor[1])==0.0F ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Texture.EnvColor[2])==0.0F ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Texture.EnvColor[3])==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_TEXTURE_ENV_MODE:
  *params = ( (ctx->Texture.EnvMode)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_TEXTURE_GEN_S:
  *params = (ctx->Texture.TexGenEnabled & 4) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_GEN_T:
  *params = (ctx->Texture.TexGenEnabled & 8) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_GEN_R:
  *params = (ctx->Texture.TexGenEnabled & 2) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_GEN_Q:
  *params = (ctx->Texture.TexGenEnabled & 1) ? GL_TRUE : GL_FALSE;
  break;
      case GL_TEXTURE_MATRIX:
  for (i=0;i<16;i++) {
     params[i] = ( (ctx->TextureMatrix[i])==0.0F ? GL_FALSE : GL_TRUE );
  }
  break;
      case GL_TEXTURE_STACK_DEPTH:
  *params = ( (ctx->TextureStackDepth)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_UNPACK_ALIGNMENT:
  *params = ( (ctx->Unpack.Alignment)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_UNPACK_LSB_FIRST:
  *params = ctx->Unpack.LsbFirst;
  break;
      case GL_UNPACK_ROW_LENGTH:
  *params = ( (ctx->Unpack.RowLength)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_UNPACK_SKIP_PIXELS:
  *params = ( (ctx->Unpack.SkipPixels)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_UNPACK_SKIP_ROWS:
  *params = ( (ctx->Unpack.SkipRows)==0 ? GL_FALSE : GL_TRUE );
  break;
  ...
  break;
      ...
      case GL_UNPACK_IMAGE_HEIGHT_EXT:
         *params = ctx->Unpack.ImageHeight;
         break;
      case GL_VIEWPORT:
  params[0] = ( (ctx->Viewport.X)==0 ? GL_FALSE : GL_TRUE );
  params[1] = ( (ctx->Viewport.Y)==0 ? GL_FALSE : GL_TRUE );
  params[2] = ( (ctx->Viewport.Width)==0 ? GL_FALSE : GL_TRUE );
  params[3] = ( (ctx->Viewport.Height)==0 ? GL_FALSE : GL_TRUE );
  break;
      case GL_ZOOM_X:
  *params = ( (ctx->Pixel.ZoomX)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_ZOOM_Y:
  *params = ( (ctx->Pixel.ZoomY)==0.0F ? GL_FALSE : GL_TRUE );
  break;
      case GL_VERTEX_ARRAY_SIZE:
         *params = ( (ctx->Array.VertexSize)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_VERTEX_ARRAY_TYPE:
         *params = ( (ctx->Array.VertexType)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_VERTEX_ARRAY_STRIDE:
         *params = ( (ctx->Array.VertexStride)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_VERTEX_ARRAY_COUNT_EXT:
         *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_NORMAL_ARRAY_TYPE:
         *params = ( (ctx->Array.NormalType)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_NORMAL_ARRAY_STRIDE:
         *params = ( (ctx->Array.NormalStride)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_NORMAL_ARRAY_COUNT_EXT:
         *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_COLOR_ARRAY_SIZE:
         *params = ( (ctx->Array.ColorSize)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_COLOR_ARRAY_TYPE:
         *params = ( (ctx->Array.ColorType)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_COLOR_ARRAY_STRIDE:
         *params = ( (ctx->Array.ColorStride)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_COLOR_ARRAY_COUNT_EXT:
         *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_INDEX_ARRAY_TYPE:
         *params = ( (ctx->Array.IndexType)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_INDEX_ARRAY_STRIDE:
         *params = ( (ctx->Array.IndexStride)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_INDEX_ARRAY_COUNT_EXT:
         *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_TEXTURE_COORD_ARRAY_SIZE:
         *params = ( (ctx->Array.TexCoordSize)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_TEXTURE_COORD_ARRAY_TYPE:
         *params = ( (ctx->Array.TexCoordType)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_TEXTURE_COORD_ARRAY_STRIDE:
         *params = ( (ctx->Array.TexCoordStride)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_TEXTURE_COORD_ARRAY_COUNT_EXT:
         *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_EDGE_FLAG_ARRAY_STRIDE:
         *params = ( (ctx->Array.EdgeFlagStride)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_EDGE_FLAG_ARRAY_EXT:
         *params = ( (0)==0 ? GL_FALSE : GL_TRUE );
         break;
      case GL_TEXTURE_BINDING_1D:
         *params = ( (ctx->Texture.Current1D->Name)==0 ? GL_FALSE : GL_TRUE );
          break;
      case GL_TEXTURE_BINDING_2D:
         *params = ( (ctx->Texture.Current2D->Name)==0 ? GL_FALSE : GL_TRUE );
          break;
...
void gl_GetDoublev( GLcontext *ctx, GLenum pname, GLdouble *params )
{
  ...
  *params = (GLdouble) 1.0;
  break;
      case GL_LINE_WIDTH_RANGE:
  params[0] = (GLdouble) 1.0;
  params[1] = (GLdouble) 10.0;
  break;
      case GL_LIST_BASE:
  ...
  *params = (GLdouble) 32;
  break;
      case GL_MAX_TEXTURE_SIZE:
  *params = (GLdouble) (1 << (11 -1));
  break;
      case GL_MAX_TEXTURE_STACK_DEPTH:
  *params = (GLdouble) 10;
  break;
      case GL_MAX_VIEWPORT_DIMS:
         params[0] = (GLdouble) 1280;
         params[1] = (GLdouble) 1024;
         break;
      case GL_MODELVIEW_MATRIX:
  for (i=0;i<16;i++) {
  ...
  *params = 0.0;
  break;
      case GL_TEXTURE_1D:
  *params = (ctx->Texture.Enabled & 1) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_2D:
  *params = (ctx->Texture.Enabled & 2) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_3D_EXT:
  *params = (ctx->Texture.Enabled & 4) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_ENV_COLOR:
  ...
  *params = (GLdouble) ctx->Texture.EnvMode;
  break;
      case GL_TEXTURE_GEN_S:
  *params = (ctx->Texture.TexGenEnabled & 4) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_GEN_T:
  *params = (ctx->Texture.TexGenEnabled & 8) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_GEN_R:
  *params = (ctx->Texture.TexGenEnabled & 2) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_GEN_Q:
  *params = (ctx->Texture.TexGenEnabled & 1) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_MATRIX:
         for (i=0;i<16;i++) {
...
void gl_GetFloatv( GLcontext *ctx, GLenum pname, GLfloat *params )
{
  ...
  *params = (GLfloat) 1.0;
  break;
      case GL_LINE_WIDTH_RANGE:
  params[0] = (GLfloat) 1.0;
  params[1] = (GLfloat) 10.0;
  break;
      case GL_LIST_BASE:
  ...
  *params = (GLfloat) 32;
  break;
      case GL_MAX_TEXTURE_SIZE:
  *params = (GLfloat) (1 << (11 -1));
  break;
      case GL_MAX_TEXTURE_STACK_DEPTH:
  *params = (GLfloat) 10;
  break;
      case GL_MAX_VIEWPORT_DIMS:
         params[0] = (GLfloat) 1280;
         params[1] = (GLfloat) 1024;
         break;
      case GL_MODELVIEW_MATRIX:
  for (i=0;i<16;i++) {
...
void gl_GetIntegerv( GLcontext *ctx, GLenum pname, GLint *params )
{
   ...
   switch (pname) {
      ...
      case GL_ACCUM_ALPHA_BITS:
         *params = (GLint) (sizeof(GLaccum)*8);
         break;
      case GL_ACCUM_CLEAR_VALUE:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Accum.ClearColor[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Accum.ClearColor[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Accum.ClearColor[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Accum.ClearColor[3])) );
         break;
      case GL_ALPHA_BIAS:
      ...
      case GL_ALPHA_TEST:
         *params = (GLint) ctx->Color.AlphaEnabled;
         break;
      case GL_ALPHA_TEST_REF:
         *params = ( (GLint) (2147483647.0 * (ctx->Color.AlphaRef)) );
         break;
      case GL_ALPHA_TEST_FUNC:
  ...
  *params = (GLint) ctx->Color.BlendEquation;
  break;
      case GL_BLEND_COLOR_EXT:
  params[0] = ( (GLint) (2147483647.0 * (ctx->Color.BlendColor[0])) );
  params[1] = ( (GLint) (2147483647.0 * (ctx->Color.BlendColor[1])) );
  params[2] = ( (GLint) (2147483647.0 * (ctx->Color.BlendColor[2])) );
  params[3] = ( (GLint) (2147483647.0 * (ctx->Color.BlendColor[3])) );
  break;
      case GL_BLUE_BIAS:
      ...
      case GL_CLIP_PLANE5:
         ...
         *params = (GLint) ctx->Transform.ClipEnabled[i];
         break;
      case GL_COLOR_CLEAR_VALUE:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Color.ClearColor[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Color.ClearColor[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Color.ClearColor[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Color.ClearColor[3])) );
         break;
      case GL_COLOR_MATERIAL:
      ...
      case GL_CULL_FACE_MODE:
         *params = (GLint) ctx->Polygon.CullFaceMode;
         break;
      case GL_CURRENT_COLOR:
         params[0] = ( (GLint) (2147483647.0 * ((ctx->Current.IntColor[0]/ctx->Visual->RedScale))) );
         params[1] = ( (GLint) (2147483647.0 * ((ctx->Current.IntColor[1]/ctx->Visual->GreenScale))) );
         params[2] = ( (GLint) (2147483647.0 * ((ctx->Current.IntColor[2]/ctx->Visual->BlueScale))) );
         params[3] = ( (GLint) (2147483647.0 * ((ctx->Current.IntColor[3]/ctx->Visual->AlphaScale))) );
         break;
      case GL_CURRENT_INDEX:
         *params = (GLint) ctx->Current.Index;
         break;
      case GL_CURRENT_NORMAL:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Current.Normal[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Current.Normal[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Current.Normal[2])) );
         break;
      case GL_CURRENT_RASTER_COLOR:
  params[0] = ( (GLint) (2147483647.0 * (ctx->Current.RasterColor[0])) );
  params[1] = ( (GLint) (2147483647.0 * (ctx->Current.RasterColor[1])) );
  params[2] = ( (GLint) (2147483647.0 * (ctx->Current.RasterColor[2])) );
  params[3] = ( (GLint) (2147483647.0 * (ctx->Current.RasterColor[3])) );
  break;
      case GL_CURRENT_RASTER_DISTANCE:
  ...
  *params = (GLint) ctx->Fog.Enabled;
  break;
      case GL_FOG_COLOR:
  params[0] = ( (GLint) (2147483647.0 * (ctx->Fog.Color[0])) );
  params[1] = ( (GLint) (2147483647.0 * (ctx->Fog.Color[1])) );
  params[2] = ( (GLint) (2147483647.0 * (ctx->Fog.Color[2])) );
  params[3] = ( (GLint) (2147483647.0 * (ctx->Fog.Color[3])) );
  break;
      case GL_FOG_DENSITY:
  ...
  *params = (GLint) ctx->Light.Enabled;
  break;
      case GL_LIGHT_MODEL_AMBIENT:
  params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Model.Ambient[0])) );
  params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Model.Ambient[1])) );
  params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Model.Ambient[2])) );
  params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Model.Ambient[3])) );
  break;
      case GL_LIGHT_MODEL_LOCAL_VIEWER:
  ...
  *params = (ctx->Texture.Enabled & 4) ? 1.0 : 0.0;
  break;
      case GL_TEXTURE_ENV_COLOR:
  params[0] = ( (GLint) (2147483647.0 * (ctx->Texture.EnvColor[0])) );
  params[1] = ( (GLint) (2147483647.0 * (ctx->Texture.EnvColor[1])) );
  params[2] = ( (GLint) (2147483647.0 * (ctx->Texture.EnvColor[2])) );
  params[3] = ( (GLint) (2147483647.0 * (ctx->Texture.EnvColor[3])) );
  break;
      case GL_TEXTURE_ENV_MODE:
  *params = (GLint) ctx->Texture.EnvMode;
  break;
      case GL_TEXTURE_GEN_S:
  *params = (ctx->Texture.TexGenEnabled & 4) ? 1 : 0;
  break;
      case GL_TEXTURE_GEN_T:
  *params = (ctx->Texture.TexGenEnabled & 8) ? 1 : 0;
  break;
      case GL_TEXTURE_GEN_R:
  *params = (ctx->Texture.TexGenEnabled & 2) ? 1 : 0;
  break;
      case GL_TEXTURE_GEN_Q:
  *params = (ctx->Texture.TexGenEnabled & 1) ? 1 : 0;
  break;
      case GL_TEXTURE_MATRIX:
         for (i=0;i<16;i++) {
