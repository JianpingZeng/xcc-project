                             ...
                             GLint destx, GLint desty )
{
  ...
  || ctx->Pixel.AlphaScale!=1.0 || ctx->Pixel.AlphaBias!=0.0;
   ...
   if (ctx->Depth.Test) {
      ...
      GLint z = (GLint) (ctx->Current.RasterPos[2] * 65535.0F);
      for (i=0;i<width;i++) {
         zspan[i] = z;
      }
   }
                               ...
                               GLint destx, GLint desty )
{
   ...
   if (ctx->Visual->RGBAflag) {
      ...
      memset( (void *) (red), (int) ((int) r), (size_t) (width) );
      memset( (void *) (green), (int) ((int) g), (size_t) (width) );
      memset( (void *) (blue), (int) ((int) b), (size_t) (width) );
      memset( (void *) (alpha), (int) ((int) a), (size_t) (width) );
   }
   else {
      for (i=0;i<width;i++) {
   ...
   for (j=0; j<height; j++, sy+=stepy, dy+=stepy) {
      ...
      for (i=0;i<width;i++) {
         ...
         zspan[i] = (GLint) (( (d)<(0.0) ? (0.0) : ((d)>(1.0) ? (1.0) : (d)) ) * 65535.0F);
      }
      ...
      GLenum type )
{
  ...
  gl_error( ctx, GL_INVALID_ENUM, "glCopyPixels" );
      ...
      if (ctx->Feedback.Count < ctx->Feedback.BufferSize) { ctx->Feedback.Buffer[ctx->Feedback.Count] = ((GLfloat) GL_COPY_PIXEL_TOKEN); } ctx->Feedback.Count++;;
