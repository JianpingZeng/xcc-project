...
void gl_flush_pb( GLcontext *ctx )
{
   ...
   GLubyte mask[(3*1280)+4];
   GLubyte rsave[(3*1280)];
   GLubyte gsave[(3*1280)];
   GLubyte bsave[(3*1280)];
   GLubyte asave[(3*1280)];
   ...
   if (ctx->Visual->RGBAflag) {
      ...
      if (PB->mono && ctx->MutablePixels) {
         ...
         memset( (void *) (PB->r), (int) (PB->color[0]), (size_t) (PB->count) );
         memset( (void *) (PB->g), (int) (PB->color[1]), (size_t) (PB->count) );
         memset( (void *) (PB->b), (int) (PB->color[2]), (size_t) (PB->count) );
         memset( (void *) (PB->a), (int) (PB->color[3]), (size_t) (PB->count) );
      }
  ...
  if (ctx->Texture.Enabled & 4) {
     ...
     gl_texture_pixels_3d( ctx, PB->count, PB->s, PB->t, PB->u, ((void *)0),
                                  PB->r, PB->g, PB->b, PB->a);
  }
  else if (ctx->Texture.Enabled & 2) {

     gl_texture_pixels_2d( ctx, PB->count, PB->s, PB->t, ((void *)0),
                                  PB->r, PB->g, PB->b, PB->a);
  }
  else if (ctx->Texture.Enabled & 1) {

     gl_texture_pixels_1d( ctx, PB->count, PB->s, ((void *)0),
                                  PB->r, PB->g, PB->b, PB->a );
  }
  ...
  if (ctx->Stencil.Enabled) {
     ...
     (*ctx->Driver.DepthTestPixels)( ctx, PB->count, PB->x, PB->y, PB->z, mask );
         ...
         if (ctx->RasterMask & 0x800) {
            goto CleanUp;
         }

         if (ctx->RasterMask & 0x400) {

            memcpy( (void *) (rsave), (void *) (PB->r), (size_t) (PB->count * sizeof(GLubyte)) );
            memcpy( (void *) (gsave), (void *) (PB->r), (size_t) (PB->count * sizeof(GLubyte)) );
            memcpy( (void *) (bsave), (void *) (PB->r), (size_t) (PB->count * sizeof(GLubyte)) );
            memcpy( (void *) (asave), (void *) (PB->r), (size_t) (PB->count * sizeof(GLubyte)) );
         }
  ...
  if (ctx->Stencil.Enabled) {
     ...
     (*ctx->Driver.DepthTestPixels)( ctx, PB->count, PB->x, PB->y, PB->z, mask );
         ...
         if (ctx->RasterMask & 0x400) {
            ...
            memcpy( (void *) (isave), (void *) (PB->i), (size_t) (PB->count * sizeof(GLuint)) );
         }
         ...
         if (ctx->RasterMask & 0x400) {
            ...
            (*ctx->Driver.SetBuffer)( ctx, GL_BACK );
            memcpy( (void *) (PB->i), (void *) (isave), (size_t) (PB->count * sizeof(GLuint)) );
            if (ctx->Color.SWLogicOpEnabled) {
               gl_logicop_ci_pixels( ctx, PB->count, PB->x, PB->y, PB->i, mask );
            }
            if (ctx->Color.SWmasking) {
