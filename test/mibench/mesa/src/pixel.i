                            ...
                            GLint y0 )
{
   ...
   GLint r0, r1, row, r;
   GLint i, j, skipcol;
   GLubyte zred[1280], zgreen[1280];
   GLubyte zblue[1280], zalpha[1280];
   GLdepth zdepth[1280];
   GLint maxwidth = ( (ctx->Buffer->Width)<(1280) ? (ctx->Buffer->Width) : (1280) );


   m = (GLint) ((n * ctx->Pixel.ZoomX) < 0.0F ? -(n * ctx->Pixel.ZoomX) : (n * ctx->Pixel.ZoomX));
   if (m==0) {
      return;
   }
   ...
   ((m <= 1280) ? (void) (0) : __assert_fail ("m <= 1280", "pixel.c", 188, __PRETTY_FUNCTION__));
                            ...
                            const GLuint indexes[], GLint y0 )
{
   ...
   ((m <= 1280) ? (void) (0) : __assert_fail ("m <= 1280", "pixel.c", 286, __PRETTY_FUNCTION__));
                              ...
                              const GLubyte stencil[], GLint y0 )
{
   ...
   ((m <= 1280) ? (void) (0) : __assert_fail ("m <= 1280", "pixel.c", 376, __PRETTY_FUNCTION__));
                    ...
                    GLenum map, GLint mapsize, const GLfloat *values )
{
  ...
  break;
      case GL_PIXEL_MAP_I_TO_R:
         ...
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapItoR[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_I_TO_G:
         ctx->Pixel.MapItoGsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapItoG[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_I_TO_B:
         ctx->Pixel.MapItoBsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapItoB[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_I_TO_A:
         ctx->Pixel.MapItoAsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapItoA[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_R_TO_R:
         ctx->Pixel.MapRtoRsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapRtoR[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_G_TO_G:
         ctx->Pixel.MapGtoGsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapGtoG[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_B_TO_B:
         ctx->Pixel.MapBtoBsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapBtoB[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      case GL_PIXEL_MAP_A_TO_A:
         ctx->Pixel.MapAtoAsize = mapsize;
         for (i=0;i<mapsize;i++) {
     ctx->Pixel.MapAtoA[i] = ( (values[i])<(0.0) ? (0.0) : ((values[i])>(1.0) ? (1.0) : (values[i])) );
  }
  break;
      default:
...
void gl_GetPixelMapfv( GLcontext *ctx, GLenum map, GLfloat *values )
{
  ...
  break;
      case GL_PIXEL_MAP_I_TO_R:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapItoR), (size_t) (ctx->Pixel.MapItoRsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_I_TO_G:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapItoG), (size_t) (ctx->Pixel.MapItoGsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_I_TO_B:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapItoB), (size_t) (ctx->Pixel.MapItoBsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_I_TO_A:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapItoA), (size_t) (ctx->Pixel.MapItoAsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_R_TO_R:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapRtoR), (size_t) (ctx->Pixel.MapRtoRsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_G_TO_G:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapGtoG), (size_t) (ctx->Pixel.MapGtoGsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_B_TO_B:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapBtoB), (size_t) (ctx->Pixel.MapBtoBsize*sizeof(GLfloat)) );
  break;
      case GL_PIXEL_MAP_A_TO_A:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapAtoA), (size_t) (ctx->Pixel.MapAtoAsize*sizeof(GLfloat)) );
  break;
      default:
...
void gl_GetPixelMapuiv( GLcontext *ctx, GLenum map, GLuint *values )
{
   ...
   switch (map) {
      case GL_PIXEL_MAP_I_TO_I:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapItoI), (size_t) (ctx->Pixel.MapItoIsize*sizeof(GLint)) );
  break;
      case GL_PIXEL_MAP_S_TO_S:
         memcpy( (void *) (values), (void *) (ctx->Pixel.MapStoS), (size_t) (ctx->Pixel.MapStoSsize*sizeof(GLint)) );
  break;
      case GL_PIXEL_MAP_I_TO_R:
  for (i=0;i<ctx->Pixel.MapItoRsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapItoR[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_I_TO_G:
  for (i=0;i<ctx->Pixel.MapItoGsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapItoG[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_I_TO_B:
  for (i=0;i<ctx->Pixel.MapItoBsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapItoB[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_I_TO_A:
  for (i=0;i<ctx->Pixel.MapItoAsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapItoA[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_R_TO_R:
  for (i=0;i<ctx->Pixel.MapRtoRsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapRtoR[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_G_TO_G:
  for (i=0;i<ctx->Pixel.MapGtoGsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapGtoG[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_B_TO_B:
  for (i=0;i<ctx->Pixel.MapBtoBsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapBtoB[i]) * 4294967295.0));
  }
  break;
      case GL_PIXEL_MAP_A_TO_A:
  for (i=0;i<ctx->Pixel.MapAtoAsize;i++) {
     values[i] = ((GLuint) ((ctx->Pixel.MapAtoA[i]) * 4294967295.0));
  }
  break;
      default:
         gl_error( ctx, GL_INVALID_ENUM, "glGetPixelMapfv" );
...
void gl_GetPixelMapusv( GLcontext *ctx, GLenum map, GLushort *values )
{
  ...
  break;
      case GL_PIXEL_MAP_I_TO_R:
  for (i=0;i<ctx->Pixel.MapItoRsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapItoR[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_I_TO_G:
  for (i=0;i<ctx->Pixel.MapItoGsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapItoG[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_I_TO_B:
  for (i=0;i<ctx->Pixel.MapItoBsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapItoB[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_I_TO_A:
  for (i=0;i<ctx->Pixel.MapItoAsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapItoA[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_R_TO_R:
  for (i=0;i<ctx->Pixel.MapRtoRsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapRtoR[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_G_TO_G:
  for (i=0;i<ctx->Pixel.MapGtoGsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapGtoG[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_B_TO_B:
  for (i=0;i<ctx->Pixel.MapBtoBsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapBtoB[i]) * 65535.0F));
  }
  break;
      case GL_PIXEL_MAP_A_TO_A:
  for (i=0;i<ctx->Pixel.MapAtoAsize;i++) {
     values[i] = ((GLushort) (GLint) ((ctx->Pixel.MapAtoA[i]) * 65535.0F));
  }
  break;
      default:
         gl_error( ctx, GL_INVALID_ENUM, "glGetPixelMapfv" );
                          ...
                          const GLvoid *pixels )
{
   ...
   if (type==GL_BITMAP) {
      ...
      bytes = ( (width * height) % (8) == 0 ? (width * height)/(8) : (width * height)/(8)+1 );
  ...
  return ((void *)0);
      ...
      width_in_bytes = ( (width) % (8) == 0 ? (width)/(8) : (width)/(8)+1 );
      dst = buffer;
      for (i=0;i<height;i++) {
  ...
  memcpy( (void *) (dst), (void *) (src), (size_t) (width_in_bytes) );
  dst += width_in_bytes;
      }
