...
# 52 "light.c" 2
# 1 "/home/xlous/Development/experiment/arm-2010.09/bin/../lib/gcc/arm-none-linux-gnueabi/4.5.1/include/float.h" 1 3 4
# 53 "light.c" 2
                 ...
                 GLint nparams )
{
   ...
   switch (pname) {
      case GL_AMBIENT:
         ctx->Light.Light[l].Ambient[0] = params[0]; ctx->Light.Light[l].Ambient[1] = params[1]; ctx->Light.Light[l].Ambient[2] = params[2]; ctx->Light.Light[l].Ambient[3] = params[3];;
         break;
      case GL_DIFFUSE:
         ctx->Light.Light[l].Diffuse[0] = params[0]; ctx->Light.Light[l].Diffuse[1] = params[1]; ctx->Light.Light[l].Diffuse[2] = params[2]; ctx->Light.Light[l].Diffuse[3] = params[3];;
         break;
      case GL_SPECULAR:
         ctx->Light.Light[l].Specular[0] = params[0]; ctx->Light.Light[l].Specular[1] = params[1]; ctx->Light.Light[l].Specular[2] = params[2]; ctx->Light.Light[l].Specular[3] = params[3];;
         break;
      case GL_POSITION:

  ctx->Light.Light[l].Position[0] = ctx->ModelViewMatrix[0] * params[0] + ctx->ModelViewMatrix[4] * params[1] + ctx->ModelViewMatrix[8] * params[2] + ctx->ModelViewMatrix[12] * params[3]; ctx->Light.Light[l].Position[1] = ctx->ModelViewMatrix[1] * params[0] + ctx->ModelViewMatrix[5] * params[1] + ctx->ModelViewMatrix[9] * params[2] + ctx->ModelViewMatrix[13] * params[3]; ctx->Light.Light[l].Position[2] = ctx->ModelViewMatrix[2] * params[0] + ctx->ModelViewMatrix[6] * params[1] + ctx->ModelViewMatrix[10] * params[2] + ctx->ModelViewMatrix[14] * params[3]; ctx->Light.Light[l].Position[3] = ctx->ModelViewMatrix[3] * params[0] + ctx->ModelViewMatrix[7] * params[1] + ctx->ModelViewMatrix[11] * params[2] + ctx->ModelViewMatrix[15] * params[3];
                                  ;
         break;
      ...
      case GL_SPOT_CUTOFF:
         ...
         ctx->Light.Light[l].CosCutoff = cos(params[0]*(3.14159265358979323846/180.0));
         break;
                    ...
                    GLenum light, GLenum pname, GLfloat *params )
{
   ...
   switch (pname) {
      case GL_AMBIENT:
         params[0] = ctx->Light.Light[l].Ambient[0]; params[1] = ctx->Light.Light[l].Ambient[1]; params[2] = ctx->Light.Light[l].Ambient[2]; params[3] = ctx->Light.Light[l].Ambient[3];;
         break;
      case GL_DIFFUSE:
         params[0] = ctx->Light.Light[l].Diffuse[0]; params[1] = ctx->Light.Light[l].Diffuse[1]; params[2] = ctx->Light.Light[l].Diffuse[2]; params[3] = ctx->Light.Light[l].Diffuse[3];;
         break;
      case GL_SPECULAR:
         params[0] = ctx->Light.Light[l].Specular[0]; params[1] = ctx->Light.Light[l].Specular[1]; params[2] = ctx->Light.Light[l].Specular[2]; params[3] = ctx->Light.Light[l].Specular[3];;
         break;
      case GL_POSITION:
         params[0] = ctx->Light.Light[l].Position[0]; params[1] = ctx->Light.Light[l].Position[1]; params[2] = ctx->Light.Light[l].Position[2]; params[3] = ctx->Light.Light[l].Position[3];;
         break;
      case GL_SPOT_DIRECTION:
         params[0] = ctx->Light.Light[l].Direction[0]; params[1] = ctx->Light.Light[l].Direction[1]; params[2] = ctx->Light.Light[l].Direction[2];;
         break;
      case GL_SPOT_EXPONENT:
...
void gl_GetLightiv( GLcontext *ctx, GLenum light, GLenum pname, GLint *params )
{
   ...
   switch (pname) {
      case GL_AMBIENT:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Ambient[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Ambient[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Ambient[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Ambient[3])) );
         break;
      case GL_DIFFUSE:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Diffuse[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Diffuse[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Diffuse[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Diffuse[3])) );
         break;
      case GL_SPECULAR:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Specular[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Specular[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Specular[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Light[l].Specular[3])) );
         break;
      case GL_POSITION:
...
void gl_LightModelfv( GLcontext *ctx, GLenum pname, const GLfloat *params )
{
   switch (pname) {
      case GL_LIGHT_MODEL_AMBIENT:
         ctx->Light.Model.Ambient[0] = params[0]; ctx->Light.Model.Ambient[1] = params[1]; ctx->Light.Model.Ambient[2] = params[2]; ctx->Light.Model.Ambient[3] = params[3];;
         break;
...
GLuint gl_material_bitmask( GLenum face, GLenum pname )
{
   ...
   if (face==GL_FRONT) {
      bitmask &= (0x40 | 0x1 | 0x4 | 0x10 | 0x100 | 0x400);
   }
   else if (face==GL_BACK) {
      bitmask &= (0x80 | 0x2 | 0x8 | 0x20 | 0x200 | 0x800);
   }
...
void gl_set_material( GLcontext *ctx, GLuint bitmask, const GLfloat *params )
{
   ...
   if (bitmask & 0x1) {
      mat[0].Ambient[0] = params[0]; mat[0].Ambient[1] = params[1]; mat[0].Ambient[2] = params[2]; mat[0].Ambient[3] = params[3];;
   }
   if (bitmask & 0x2) {
      mat[1].Ambient[0] = params[0]; mat[1].Ambient[1] = params[1]; mat[1].Ambient[2] = params[2]; mat[1].Ambient[3] = params[3];;
   }
   if (bitmask & 0x4) {
      mat[0].Diffuse[0] = params[0]; mat[0].Diffuse[1] = params[1]; mat[0].Diffuse[2] = params[2]; mat[0].Diffuse[3] = params[3];;
   }
   if (bitmask & 0x8) {
      mat[1].Diffuse[0] = params[0]; mat[1].Diffuse[1] = params[1]; mat[1].Diffuse[2] = params[2]; mat[1].Diffuse[3] = params[3];;
   }
   if (bitmask & 0x10) {
      mat[0].Specular[0] = params[0]; mat[0].Specular[1] = params[1]; mat[0].Specular[2] = params[2]; mat[0].Specular[3] = params[3];;
   }
   if (bitmask & 0x20) {
      mat[1].Specular[0] = params[0]; mat[1].Specular[1] = params[1]; mat[1].Specular[2] = params[2]; mat[1].Specular[3] = params[3];;
   }
   if (bitmask & 0x40) {
      mat[0].Emission[0] = params[0]; mat[0].Emission[1] = params[1]; mat[0].Emission[2] = params[2]; mat[0].Emission[3] = params[3];;
   }
   if (bitmask & 0x80) {
      mat[1].Emission[0] = params[0]; mat[1].Emission[1] = params[1]; mat[1].Emission[2] = params[2]; mat[1].Emission[3] = params[3];;
   }
   if (bitmask & 0x100) {
      mat[0].Shininess = ( (params[0])<(0.0) ? (0.0) : ((params[0])>(128.0) ? (128.0) : (params[0])) );
      gl_compute_material_shine_table( &mat[0] );
   }
   if (bitmask & 0x200) {
      mat[1].Shininess = ( (params[0])<(0.0) ? (0.0) : ((params[0])>(128.0) ? (128.0) : (params[0])) );
                       ...
                       GLenum face, GLenum pname, GLfloat *params )
{
   ...
   switch (pname) {
      case GL_AMBIENT:
         params[0] = ctx->Light.Material[f].Ambient[0]; params[1] = ctx->Light.Material[f].Ambient[1]; params[2] = ctx->Light.Material[f].Ambient[2]; params[3] = ctx->Light.Material[f].Ambient[3];;
         break;
      case GL_DIFFUSE:
         params[0] = ctx->Light.Material[f].Diffuse[0]; params[1] = ctx->Light.Material[f].Diffuse[1]; params[2] = ctx->Light.Material[f].Diffuse[2]; params[3] = ctx->Light.Material[f].Diffuse[3];;
  break;
      case GL_SPECULAR:
         params[0] = ctx->Light.Material[f].Specular[0]; params[1] = ctx->Light.Material[f].Specular[1]; params[2] = ctx->Light.Material[f].Specular[2]; params[3] = ctx->Light.Material[f].Specular[3];;
  break;
      case GL_EMISSION:
  params[0] = ctx->Light.Material[f].Emission[0]; params[1] = ctx->Light.Material[f].Emission[1]; params[2] = ctx->Light.Material[f].Emission[2]; params[3] = ctx->Light.Material[f].Emission[3];;
  break;
      case GL_SHININESS:
                       ...
                       GLenum face, GLenum pname, GLint *params )
{
   ...
   switch (pname) {
      case GL_AMBIENT:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Ambient[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Ambient[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Ambient[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Ambient[3])) );
         break;
      case GL_DIFFUSE:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Diffuse[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Diffuse[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Diffuse[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Diffuse[3])) );
  break;
      case GL_SPECULAR:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Specular[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Specular[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Specular[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Specular[3])) );
  break;
      case GL_EMISSION:
         params[0] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Emission[0])) );
         params[1] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Emission[1])) );
         params[2] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Emission[2])) );
         params[3] = ( (GLint) (2147483647.0 * (ctx->Light.Material[f].Emission[3])) );
  break;
      case GL_SHININESS:
         *params = ( (ctx->Light.Material[f].Shininess)<0.0F ? ((GLint) ((ctx->Light.Material[f].Shininess)-0.5F)) : ((GLint) ((ctx->Light.Material[f].Shininess)+0.5F)) );
  break;
      case GL_COLOR_INDEXES:
  params[0] = ( (ctx->Light.Material[f].AmbientIndex)<0.0F ? ((GLint) ((ctx->Light.Material[f].AmbientIndex)-0.5F)) : ((GLint) ((ctx->Light.Material[f].AmbientIndex)+0.5F)) );
  params[1] = ( (ctx->Light.Material[f].DiffuseIndex)<0.0F ? ((GLint) ((ctx->Light.Material[f].DiffuseIndex)-0.5F)) : ((GLint) ((ctx->Light.Material[f].DiffuseIndex)+0.5F)) );
  params[2] = ( (ctx->Light.Material[f].SpecularIndex)<0.0F ? ((GLint) ((ctx->Light.Material[f].SpecularIndex)-0.5F)) : ((GLint) ((ctx->Light.Material[f].SpecularIndex)+0.5F)) );
  break;
      default:
         gl_error( ctx, GL_INVALID_ENUM, "glGetMaterialfv(pname)" );
   }
...
void gl_compute_spot_exp_table( struct gl_light *l )
{
   ...
   for (i=512 -1;i>0;i--) {
      if (clamp == 0) {
         tmp = pow(i/(double)(512 -1), exponent);
         if (tmp < 1.1754943508222875e-38F*100.0) {
            tmp = 0.0;
            clamp = 1;
         }
      }
...
void gl_compute_material_shine_table( struct gl_material *m )
{
   ...
   m->ShineTable[0] = 0.0;
   for (i=1;i<200;i++) {
      double x = pow( i/(double)(200 -1), exponent );
      if (x<1.0e-10) {
         m->ShineTable[i] = 0.0;
      }
      else {
...
void gl_update_lighting( GLcontext *ctx )
{
   ...
   ctx->Light.BaseColor[3] = ( (ctx->Light.Material[0].Diffuse[3])<(1.0F) ? (ctx->Light.Material[0].Diffuse[3]) : (1.0F) );


   prev_enabled = ((void *)0);
   ctx->Light.FirstEnabled = ((void *)0);
   for (i=0;i<8;i++) {
      ctx->Light.Light[i].NextEnabled = ((void *)0);
   ...
   for (light = ctx->Light.FirstEnabled; light; light = light->NextEnabled) {
      ...
      light->VP_inf_norm[0] = light->Position[0]; light->VP_inf_norm[1] = light->Position[1]; light->VP_inf_norm[2] = light->Position[2];;
      { GLfloat len; len = sqrt(light->VP_inf_norm[0]*light->VP_inf_norm[0]+light->VP_inf_norm[1]*light->VP_inf_norm[1]+light->VP_inf_norm[2]*light->VP_inf_norm[2]); if (len>0.0001) { GLfloat scale = 1.0F / len; light->VP_inf_norm[0] *= scale; light->VP_inf_norm[1] *= scale; light->VP_inf_norm[2] *= scale; } };


      light->h_inf_norm[0] = light->VP_inf_norm[0]; light->h_inf_norm[1] = light->VP_inf_norm[1]; light->h_inf_norm[2] = light->VP_inf_norm[2];;
      light->h_inf_norm[2] += 1.0F;
      { GLfloat len; len = sqrt(light->h_inf_norm[0]*light->h_inf_norm[0]+light->h_inf_norm[1]*light->h_inf_norm[1]+light->h_inf_norm[2]*light->h_inf_norm[2]); if (len>0.0001) { GLfloat scale = 1.0F / len; light->h_inf_norm[0] *= scale; light->h_inf_norm[1] *= scale; light->h_inf_norm[2] *= scale; } };

      light->NormDirection[0] = light->Direction[0]; light->NormDirection[1] = light->Direction[1]; light->NormDirection[2] = light->Direction[2];;
      { GLfloat len; len = sqrt(light->NormDirection[0]*light->NormDirection[0]+light->NormDirection[1]*light->NormDirection[1]+light->NormDirection[2]*light->NormDirection[2]); if (len>0.0001) { GLfloat scale = 1.0F / len; light->NormDirection[0] *= scale; light->NormDirection[1] *= scale; light->NormDirection[2] *= scale; } };
                              ...
                              GLfixed backcolor[][4] )
{
   ...
   for (side=0;side<=twoside;side++) {
      ...
      baseA = mat->Diffuse[3];
      sumA = (GLfixed) (( (baseA)<(0.0F) ? (0.0F) : ((baseA)>(1.0F) ? (1.0F) : (baseA)) ) * ascale);
      ...
      for (j=0;j<n;j++) {
            ...
            if (n_dot_VP<=0.0F) {
               ...
               if (n_dot_h<=0.0F) {
                  ...
                  if (n_dot_h>1.0F) {
                     ...
                     int k = (int) (n_dot_h * (GLfloat) (200 -1));
         ...
         if (side==0) {
            ...
            frontcolor[j][0] = (GLfixed) (( (sumR)<(0.0F) ? (0.0F) : ((sumR)>(1.0F) ? (1.0F) : (sumR)) ) * rscale);
            frontcolor[j][1] = (GLfixed) (( (sumG)<(0.0F) ? (0.0F) : ((sumG)>(1.0F) ? (1.0F) : (sumG)) ) * gscale);
            frontcolor[j][2] = (GLfixed) (( (sumB)<(0.0F) ? (0.0F) : ((sumB)>(1.0F) ? (1.0F) : (sumB)) ) * bscale);
            frontcolor[j][3] = sumA;
         }
         else {

            backcolor[j][0] = (GLfixed) (( (sumR)<(0.0F) ? (0.0F) : ((sumR)>(1.0F) ? (1.0F) : (sumR)) ) * rscale);
            backcolor[j][1] = (GLfixed) (( (sumG)<(0.0F) ? (0.0F) : ((sumG)>(1.0F) ? (1.0F) : (sumG)) ) * gscale);
            backcolor[j][2] = (GLfixed) (( (sumB)<(0.0F) ? (0.0F) : ((sumB)>(1.0F) ? (1.0F) : (sumB)) ) * bscale);
            backcolor[j][3] = sumA;
         }
      }
                                   ...
                                   GLfixed backcolor[][4] )
{
   ...
   for (j=0;j<n;j++) {
      ...
      frontcolor[j][0] = (GLfixed) (( (R)<(1.0F) ? (R) : (1.0F) ) * rscale);
      frontcolor[j][1] = (GLfixed) (( (G)<(1.0F) ? (G) : (1.0F) ) * gscale);
      frontcolor[j][2] = (GLfixed) (( (B)<(1.0F) ? (B) : (1.0F) ) * bscale);
      frontcolor[j][3] = A;
