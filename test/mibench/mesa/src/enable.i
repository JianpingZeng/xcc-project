...
GLboolean gl_IsEnabled( GLcontext* ctx, GLenum cap )
{
  ...
  return (ctx->Texture.Enabled & 2) ? GL_TRUE : GL_FALSE;
      case GL_TEXTURE_3D_EXT:
         return (ctx->Texture.Enabled & 4) ? GL_TRUE : GL_FALSE;
      case GL_TEXTURE_GEN_Q:
  return (ctx->Texture.TexGenEnabled & 1) ? GL_TRUE : GL_FALSE;
      case GL_TEXTURE_GEN_R:
  return (ctx->Texture.TexGenEnabled & 2) ? GL_TRUE : GL_FALSE;
      case GL_TEXTURE_GEN_S:
  return (ctx->Texture.TexGenEnabled & 4) ? GL_TRUE : GL_FALSE;
      case GL_TEXTURE_GEN_T:
  return (ctx->Texture.TexGenEnabled & 8) ? GL_TRUE : GL_FALSE;
