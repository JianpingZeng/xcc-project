...
void gl_init_api_function_pointers( GLcontext *ctx )
{
   ...
   ctx->Exec.Vertex4f = gl_nop_vertex;
   ...
   ctx->Save.DeleteLists = gl_DeleteLists;
   ctx->Save.DeleteTextures = gl_DeleteTextures;
   ...
   ctx->Save.FeedbackBuffer = gl_FeedbackBuffer;
   ctx->Save.Finish = gl_Finish;
   ctx->Save.Flush = gl_Flush;
   ctx->Save.Fogfv = gl_save_Fogfv;
   ctx->Save.FrontFace = gl_save_FrontFace;
   ctx->Save.Frustum = gl_save_Frustum;
   ctx->Save.GenLists = gl_GenLists;
   ctx->Save.GenTextures = gl_GenTextures;
   ...
   ctx->Save.IsEnabled = gl_IsEnabled;
   ctx->Save.IsTexture = gl_IsTexture;
   ctx->Save.IsList = gl_IsList;
   ...
   ctx->Save.PopClientAttrib = gl_PopClientAttrib;
   ...
   ctx->Save.PushClientAttrib = gl_PushClientAttrib;
   ...
   ctx->Save.ReadPixels = gl_ReadPixels;
   ctx->Save.Rectf = gl_Rectf;
   ctx->Save.RenderMode = gl_RenderMode;
   ctx->Save.Rotatef = gl_save_Rotatef;
   ctx->Save.Scalef = gl_save_Scalef;
   ctx->Save.Scissor = gl_save_Scissor;
   ctx->Save.SelectBuffer = gl_SelectBuffer;
   ...
   ctx->Save.TexCoordPointer = gl_TexCoordPointer;
   ...
   ctx->Save.VertexPointer = gl_VertexPointer;
