                                              ...
                                              GLint border )
{
   ...
   ((image->Width>0) ? (void) (0) : __assert_fail ("image->Width>0", "teximage.c", 285, __PRETTY_FUNCTION__));
   ((image->Height>0) ? (void) (0) : __assert_fail ("image->Height>0", "teximage.c", 286, __PRETTY_FUNCTION__));
   ((image->Depth>0) ? (void) (0) : __assert_fail ("image->Depth>0", "teximage.c", 287, __PRETTY_FUNCTION__));
   ...
   texImage->MaxLog2 = ( (texImage->WidthLog2)>(texImage->HeightLog2) ? (texImage->WidthLog2) : (texImage->HeightLog2) );
   texImage->Data = (GLubyte *) malloc( numPixels * components );

   ((texImage->WidthLog2>=0) ? (void) (0) : __assert_fail ("texImage->WidthLog2>=0", "teximage.c", 314, __PRETTY_FUNCTION__));
   ((texImage->HeightLog2>=0) ? (void) (0) : __assert_fail ("texImage->HeightLog2>=0", "teximage.c", 315, __PRETTY_FUNCTION__));
   ((texImage->DepthLog2>=0) ? (void) (0) : __assert_fail ("texImage->DepthLog2>=0", "teximage.c", 316, __PRETTY_FUNCTION__));
      ...
      case GL_BITMAP:
         {
            ...
            ((image->Format==GL_COLOR_INDEX) ? (void) (0) : __assert_fail ("image->Format==GL_COLOR_INDEX", "teximage.c", 348, __PRETTY_FUNCTION__));
                                         ...
                                         GLint width, GLint border )
{
   ...
   if (width<2*border || width>2+(1 << (11 -1))) {
      if (target!=GL_PROXY_TEXTURE_1D) {
                                         ...
                                         GLint border )
{
   ...
   if (height<2*border || height>2+(1 << (11 -1))) {
      if (target!=GL_PROXY_TEXTURE_2D) {
                                         ...
                                         GLint depth, GLint border )
{
   ...
   if (depth<2*border || depth>2+(1 << (11 -1))) {
      if (target!=GL_PROXY_TEXTURE_3D_EXT) {
   ...
   if (image) {
      ...
      if (target==GL_TEXTURE_1D) {
         ...
         if (texture_1d_error_check( ctx, target, level, internalformat,
                                     format, type, width, border )) {
            if (level>=0 && level<11) {
               memset( (void *) (ctx->Texture.Proxy1D->Image[level]), (int) (0), (size_t) (sizeof(struct gl_texture_image)) )
                                                       ;
            }
         }
         else {
   ...
   if (image) {
      ...
      if (target==GL_TEXTURE_2D) {
         ...
         if (texture_2d_error_check( ctx, target, level, internalformat,
                                     format, type, width, height, border )) {
            if (level>=0 && level<11) {
               memset( (void *) (ctx->Texture.Proxy2D->Image[level]), (int) (0), (size_t) (sizeof(struct gl_texture_image)) )
                                                       ;
            }
         }
         else {
   ...
   if (image) {
      ...
      if (target==GL_TEXTURE_3D_EXT) {
         ...
         if (texture_3d_error_check( ctx, target, level, internalformat,
                                     ...
                                     border )) {
            if (level>=0 && level<11) {
               memset( (void *) (ctx->Texture.Proxy3D->Image[level]), (int) (0), (size_t) (sizeof(struct gl_texture_image)) )
                                                       ;
            }
         }
         else {
                       ...
                       struct gl_image *image )
{
   ...
   if (image) {
      ...
      if (texcomponents == image->Components) {
         memcpy( (void *) (dst), (void *) (image->Data), (size_t) (width * texcomponents) );
      }
      else {
                       ...
                       struct gl_image *image )
{
   ...
   if (image) {
      ...
      if (texcomponents == image->Components) {
         ...
         src = image->Data;
         for (j=0;j<height;j++) {
            memcpy( (void *) (dst), (void *) (src), (size_t) (width * texcomponents) );
                        ...
                        GLsizei width, GLint border )
{
   ...
   if (width<2*border || width>2+(1 << (11 -1)) || width<0) {
                        ...
                        GLint border )
{
   ...
   if (height<2*border || height>2+(1 << (11 -1)) || height<0) {
