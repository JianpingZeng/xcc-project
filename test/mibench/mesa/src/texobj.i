...
find_texture_object( GLcontext *ctx, GLuint name )
{
   ...
   ((name>0) ? (void) (0) : __assert_fail ("name>0", "texobj.c", 117, __PRETTY_FUNCTION__));
      ...
      if (textures[i]>0) {
         ...
         if (t) {
            if (ctx->Texture.Current1D==t) {
               ...
               t->RefCount--;
               ((t->RefCount >= 0) ? (void) (0) : __assert_fail ("t->RefCount >= 0", "texobj.c", 182, __PRETTY_FUNCTION__));
            }
            else if (ctx->Texture.Current2D==t) {

               ctx->Texture.Current2D = ctx->Shared->TexObjectList->Next;
               t->RefCount--;
               ((t->RefCount >= 0) ? (void) (0) : __assert_fail ("t->RefCount >= 0", "texobj.c", 188, __PRETTY_FUNCTION__));
            }
            else if (ctx->Texture.Current3D==t) {

               ctx->Texture.Current3D = ctx->Shared->TexObjectList->Next;
               t->RefCount--;
               ((t->RefCount >= 0) ? (void) (0) : __assert_fail ("t->RefCount >= 0", "texobj.c", 194, __PRETTY_FUNCTION__));
            }
            if (t->RefCount==0) {
               ...
               while (tcurr) {
                  if (tcurr==t) {
                     ((tprev) ? (void) (0) : __assert_fail ("tprev", "texobj.c", 202, __PRETTY_FUNCTION__));
                     tprev->Next = t->Next;
   ...
   switch (target) {
      case GL_TEXTURE_1D:
         ...
         if (ctx->Texture.Current1D != oldtexobj && oldtexobj->Name>0) {
            ...
            oldtexobj->RefCount--;
            ((oldtexobj->RefCount >= 0) ? (void) (0) : __assert_fail ("oldtexobj->RefCount >= 0", "texobj.c", 264, __PRETTY_FUNCTION__));
         }
...
# 277 "texobj.c"
         ...
         ((ctx->Texture.Current1D) ? (void) (0) : __assert_fail ("ctx->Texture.Current1D", "texobj.c", 284, __PRETTY_FUNCTION__));
         break;
      ...
      case GL_TEXTURE_2D:
         ...
         if (ctx->Texture.Current2D != oldtexobj && oldtexobj->Name>0) {
            ...
            oldtexobj->RefCount--;
            ((oldtexobj->RefCount >= 0) ? (void) (0) : __assert_fail ("oldtexobj->RefCount >= 0", "texobj.c", 320, __PRETTY_FUNCTION__));
         }
...
# 333 "texobj.c"
         ...
         ((ctx->Texture.Current2D) ? (void) (0) : __assert_fail ("ctx->Texture.Current2D", "texobj.c", 341, __PRETTY_FUNCTION__));
         break;
      ...
      case GL_TEXTURE_3D_EXT:
         ...
         if (ctx->Texture.Current3D != oldtexobj && oldtexobj->Name>0) {
            ...
            oldtexobj->RefCount--;
            ((oldtexobj->RefCount >= 0) ? (void) (0) : __assert_fail ("oldtexobj->RefCount >= 0", "texobj.c", 377, __PRETTY_FUNCTION__));
         }
...
# 390 "texobj.c"
         ...
         ((ctx->Texture.Current3D) ? (void) (0) : __assert_fail ("ctx->Texture.Current3D", "texobj.c", 398, __PRETTY_FUNCTION__));
         break;
                            ...
                            const GLclampf *priorities )
{
   ...
   for (i=0;i<n;i++) {
      ...
      if (textures[i]>0) {
         t = find_texture_object( ctx, textures[i] );
         if (t) {
            t->Priority = ( (priorities[i])<(0.0F) ? (0.0F) : ((priorities[i])>(1.0F) ? (1.0F) : (priorities[i])) );
         }
      }
   }
}
