...
;
 ...
 int width2, height2, mb_height2, chrom_width2;
 int aspectratio;
 int frame_rate_code;
 double frame_rate;
 double bit_rate;
 ...
 int conceal_tab[3];
 int qscale_tab[3], q_scale_type;
 int intravlc_tab[3], intravlc;
 int altscan_tab[3], altscan;
 int repeatfirst;
 int prog_frame;
# 36 "mpeg2enc.c" 2
