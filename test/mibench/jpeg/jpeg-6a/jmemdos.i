...
extern short far jdos_read (short handle, void far * buffer, unsigned short count)
                          ;
extern short far jdos_write (short handle, void far * buffer, unsigned short count)
                           ;
...
select_file_name (char * fname)
{
  ...
  for (;;) {
    ...
    if ((env = (const char *) getenv("TMP")) == ((void *)0))
      if ((env = (const char *) getenv("TEMP")) == ((void *)0))
 env = ".";
    if (*env == '\0')
      env = ".";
    ptr = fname;
    ...
    if ((tfile = fopen(fname, "rb")) == ((void *)0))
      break;
    fclose(tfile);
  }
}
...
close_file_store (j_common_ptr cinfo, backing_store_ptr info)
{
  ...
  ((cinfo)->err->msg_code = (JTRC_TFILE_CLOSE), strncpy((cinfo)->err->msg_parm.s, (info->temp_name), 80), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
}
   ...
   long total_bytes_needed)
{
  ...
  if (jdos_open((short far *) & handle, (char far *) info->temp_name)) {
    ...
    ((cinfo)->err->msg_code = (JERR_TFILE_CREATE), strncpy((cinfo)->err->msg_parm.s, (info->temp_name), 80), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
    return 0;
  }
  ...
  ((cinfo)->err->msg_code = (JTRC_TFILE_OPEN), strncpy((cinfo)->err->msg_parm.s, (info->temp_name), 80), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
  return 1;
}
# 312 "jmemdos.c"
  ...
  long file_offset, long byte_count)
{
  ...
  if (ctx.ax != 1)
    ((cinfo)->err->msg_code = (JERR_XMS_READ), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
   ...
   long file_offset, long byte_count)
{
  ...
  jxms_calldriver(xms_driver, (XMScontext far *) & ctx);
  if (ctx.ax != 1)
    ((cinfo)->err->msg_code = (JERR_XMS_WRITE), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
...
close_xms_store (j_common_ptr cinfo, backing_store_ptr info)
{
  ...
  ctx.ax = 0x0a00;
  jxms_calldriver(xms_driver, (XMScontext far *) & ctx);
  ((cinfo)->err->msg_code = (JTRC_XMS_CLOSE), (cinfo)->err->msg_parm.i[0] = (info->handle.xms_handle), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
  ...
  long total_bytes_needed)
{
  ...
  ((cinfo)->err->msg_code = (JTRC_XMS_OPEN), (cinfo)->err->msg_parm.i[0] = (ctx.dx), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
  return 1;
}
# 462 "jmemdos.c"
  ...
  long file_offset, long byte_count)
{
  ...
  (*((char *) &(spec.bytes[4]))) = 1;
  (*((EMSH *) &(spec.bytes[5]))) = info->handle.ems_handle;
  (*((unsigned short *) &(spec.bytes[9]))) = (unsigned short) (file_offset / 16384L);
  (*((unsigned short *) &(spec.bytes[7]))) = (unsigned short) (file_offset % 16384L);
  (*((char *) &(spec.bytes[11]))) = 0;
  (*((EMSH *) &(spec.bytes[12]))) = 0;
  (*((EMSPTR *) &(spec.bytes[14]))) = buffer_address;

  ctx.ds_si = (void far *) & spec;
  ctx.ax = 0x5700;
  jems_calldriver((EMScontext far *) & ctx);
  if ((((ctx.ax) >> 8) & 0xFF) != 0)
    ((cinfo)->err->msg_code = (JERR_EMS_READ), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
}
   ...
   long file_offset, long byte_count)
{
  ...
  (*((char *) &(spec.bytes[4]))) = 0;
  (*((EMSH *) &(spec.bytes[5]))) = 0;
  (*((EMSPTR *) &(spec.bytes[7]))) = buffer_address;
  (*((char *) &(spec.bytes[11]))) = 1;
  (*((EMSH *) &(spec.bytes[12]))) = info->handle.ems_handle;
  (*((unsigned short *) &(spec.bytes[16]))) = (unsigned short) (file_offset / 16384L);
  (*((unsigned short *) &(spec.bytes[14]))) = (unsigned short) (file_offset % 16384L);

  ctx.ds_si = (void far *) & spec;
  ctx.ax = 0x5700;
  jems_calldriver((EMScontext far *) & ctx);
  if ((((ctx.ax) >> 8) & 0xFF) != 0)
    ((cinfo)->err->msg_code = (JERR_EMS_WRITE), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
}
...
close_ems_store (j_common_ptr cinfo, backing_store_ptr info)
{
  ...
  jems_calldriver((EMScontext far *) & ctx);
  ((cinfo)->err->msg_code = (JTRC_EMS_CLOSE), (cinfo)->err->msg_parm.i[0] = (info->handle.ems_handle), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
  ...
  long total_bytes_needed)
{
  ...
  ctx.ax = 0x4600;
  jems_calldriver((EMScontext far *) & ctx);
  if ((((ctx.ax) >> 8) & 0xFF) != 0 || ((ctx.ax) & 0xFF) < 0x40)
    return 0;


  ctx.ax = 0x4300;
  ctx.bx = (unsigned short) ((total_bytes_needed + 16384L -1L) / 16384L);
  jems_calldriver((EMScontext far *) & ctx);
  if ((((ctx.ax) >> 8) & 0xFF) != 0)
    return 0;
  ...
  ((cinfo)->err->msg_code = (JTRC_EMS_OPEN), (cinfo)->err->msg_parm.i[0] = (ctx.dx), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
  return 1;
}
# 596 "jmemdos.c"
void
