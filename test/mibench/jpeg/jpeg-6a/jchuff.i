...
extern void jpeg_make_c_derived_tbl
 (j_compress_ptr cinfo, JHUFF_TBL * htbl, c_derived_tbl ** pdtbl);
...
start_pass_huff (j_compress_ptr cinfo, boolean gather_statistics)
{
  ...
  for (ci = 0; ci < cinfo->comps_in_scan; ci++) {
    ...
    if (dctbl < 0 || dctbl >= 4 ||
 (cinfo->dc_huff_tbl_ptrs[dctbl] == ((void *)0) && !gather_statistics))
      ((cinfo)->err->msg_code = (JERR_NO_HUFF_TABLE), (cinfo)->err->msg_parm.i[0] = (dctbl), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
    if (actbl < 0 || actbl >= 4 ||
 (cinfo->ac_huff_tbl_ptrs[actbl] == ((void *)0) && !gather_statistics))
