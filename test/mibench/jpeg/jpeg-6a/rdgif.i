...
static JDIMENSION get_pixel_rows
 (j_compress_ptr cinfo, cjpeg_source_ptr sinfo);
static JDIMENSION load_interlaced_image
 (j_compress_ptr cinfo, cjpeg_source_ptr sinfo);
static JDIMENSION get_interlaced_row
 (j_compress_ptr cinfo, cjpeg_source_ptr sinfo);
...
start_input_gif (j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
  ...
  if ((hdrbuf[3] != '8' || hdrbuf[4] != '7' || hdrbuf[5] != 'a') &&
    ...
    do { int * _mp = (cinfo)->err->msg_parm.i; _mp[0] = (hdrbuf[3]); _mp[1] = (hdrbuf[4]); _mp[2] = (hdrbuf[5]); (cinfo)->err->msg_code = (JTRC_GIF_BADVERSION); (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)); } while (0);
  ...
  source->symbol_head = (UINT16 *)
    ...
    (1<<12) * ((size_t) sizeof(UINT16)));
  source->symbol_tail = (UINT8 *)
    (*cinfo->mem->alloc_large) ((j_common_ptr) cinfo, 1,
    (1<<12) * ((size_t) sizeof(UINT8)));
  ...
  do { int * _mp = (cinfo)->err->msg_parm.i; _mp[0] = (width); _mp[1] = (height); _mp[2] = (colormaplen); (cinfo)->err->msg_code = (JTRC_GIF); (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)); } while (0);
}
# 535 "rdgif.c"
static JDIMENSION
...
jinit_read_gif (j_compress_ptr cinfo)
{
  ...
  source = (gif_source_ptr)
      ...
      ((size_t) sizeof(gif_source_struct)));
  source->cinfo = cinfo;
