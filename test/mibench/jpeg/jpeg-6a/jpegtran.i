...
main (int argc, char **argv)
{
  ...
  jpeg_CreateDecompress((&srcinfo), 61, (size_t) sizeof(struct jpeg_decompress_struct));

  dstinfo.err = jpeg_std_error(&jdsterr);
  jpeg_CreateCompress((&dstinfo), 61, (size_t) sizeof(struct jpeg_compress_struct));
# 276 "jpegtran.c"
  file_index = parse_switches(&dstinfo, argc, argv, 0, 0);
...
# 298 "jpegtran.c"
  ...
  file_index = parse_switches(&dstinfo, argc, argv, 0, 1);
