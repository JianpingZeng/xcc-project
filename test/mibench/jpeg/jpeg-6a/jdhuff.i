...
decode_mcu (j_decompress_ptr cinfo, JBLOCKROW *MCU_data)
{
 ...
 return 0;
  ...
  br_state.cinfo = cinfo; br_state.next_input_byte = cinfo->src->next_input_byte; br_state.bytes_in_buffer = cinfo->src->bytes_in_buffer; br_state.unread_marker = cinfo->unread_marker; get_buffer = entropy->bitstate.get_buffer; bits_left = entropy->bitstate.bits_left; br_state.printed_eod_ptr = & entropy->bitstate.printed_eod;
  ((state) = (entropy->saved));
...
skip_ACs:
 ...
 if (s) {
  ...
  cinfo->src->next_input_byte = br_state.next_input_byte; cinfo->src->bytes_in_buffer = br_state.bytes_in_buffer; cinfo->unread_marker = br_state.unread_marker; entropy->bitstate.get_buffer = get_buffer; entropy->bitstate.bits_left = bits_left;
  ((entropy->saved) = (state));
