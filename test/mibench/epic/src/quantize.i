...
quantize_pyr (float_pyr, q_pyr, im_size, num_levels, compression_factor, bin_size)
 ...
 else bin_size[bin_index] = (BinValueType) (the_bin_size+0.5);
...
quantize_image (float_im, q_im, im_size, bin_size)
  ...
  if ( max_abs >= ((511 -2)*(*bin_size)/2) )
      {
      i = (int) *bin_size;
      *bin_size = (BinValueType) ( 2*max_abs/(511 -2) + 0.5 );
...
unquantize_image(q_im, res, im_size, bin_size)
  ...
  register float correction = bin_size * 0.18 - 0.5;
