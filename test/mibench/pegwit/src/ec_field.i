...
# 131 "/home/xlous/Development/experiment/arm-2010.09/bin/../arm-none-linux-gnueabi/libc/usr/include/time.h" 3 4
...
struct sigevent;
# 180 "/home/xlous/Development/experiment/arm-2010.09/bin/../arm-none-linux-gnueabi/libc/usr/include/time.h" 3 4
...
static lunit *expt = ((void *)0);
static lunit *logt = ((void *)0);
...

{
 ...
 if (logt != ((void *)0) && expt != ((void *)0)) {

  return 0;
 }
 if (logt != ((void *)0) && expt == ((void *)0) ||
  logt == ((void *)0) && expt != ((void *)0)) {
  return 2;
 }
 if ((logt = (lunit *) malloc ((1U << 15) * sizeof (lunit))) == ((void *)0)) {
  return 1;
 }
 if ((expt = (lunit *) malloc ((1U << 15) * sizeof (lunit))) == ((void *)0)) {
  free (logt); logt = ((void *)0);
  return 1;
 }
 root = (1U << 15) | 0x0003U;
 expt[0] = 1;
...
{
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 183, __PRETTY_FUNCTION__));
 ((q != ((void *)0)) ? (void) (0) : __assert_fail ("q != ((void *)0)", "ec_field.c", 184, __PRETTY_FUNCTION__));
...
{
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 192, __PRETTY_FUNCTION__));
...
{
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 200, __PRETTY_FUNCTION__));
 ((q != ((void *)0)) ? (void) (0) : __assert_fail ("q != ((void *)0)", "ec_field.c", 201, __PRETTY_FUNCTION__));
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 211, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 212, __PRETTY_FUNCTION__));
 ((q != ((void *)0)) ? (void) (0) : __assert_fail ("q != ((void *)0)", "ec_field.c", 213, __PRETTY_FUNCTION__));
 ((r != ((void *)0)) ? (void) (0) : __assert_fail ("r != ((void *)0)", "ec_field.c", 214, __PRETTY_FUNCTION__));
 if (q[0] > r[0]) {
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 275, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 276, __PRETTY_FUNCTION__));
 ((q != ((void *)0)) ? (void) (0) : __assert_fail ("q != ((void *)0)", "ec_field.c", 277, __PRETTY_FUNCTION__));
 ((r != p) ? (void) (0) : __assert_fail ("r != p", "ec_field.c", 278, __PRETTY_FUNCTION__));
 ((r != q) ? (void) (0) : __assert_fail ("r != q", "ec_field.c", 279, __PRETTY_FUNCTION__));
 if (p[0] && q[0]) {
  ...
  gfClear (r);
  for (i = p[0]; i; i--) {
   if ((log_pi = logt[p[i]]) != ((1U << 15)-1)) {
    for (j = q[0]; j; j--) {
     if ((log_qj = lg[j]) != ((1U << 15)-1)) {

      r[i+j-1] ^= expt[(x = log_pi + log_qj) >= ((1U << 15)-1) ? x - ((1U << 15)-1) : x];
     }
    }
   }
  }
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 316, __PRETTY_FUNCTION__));
 ((r != ((void *)0)) ? (void) (0) : __assert_fail ("r != ((void *)0)", "ec_field.c", 317, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 318, __PRETTY_FUNCTION__));
 if (p[0]) {

  i = p[0];
  if ((x = logt[p[i]]) != ((1U << 15)-1)) {
   r[2*i - 1] = expt[(x += x) >= ((1U << 15)-1) ? x - ((1U << 15)-1) : x];
  } else {
   r[2*i - 1] = 0;
  }
  for (i = p[0] - 1; i; i--) {
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 350, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 351, __PRETTY_FUNCTION__));
 ((b != 0) ? (void) (0) : __assert_fail ("b != 0", "ec_field.c", 352, __PRETTY_FUNCTION__));
 for (i = p[0]; i; i--) {
  if ((x = logt[p[i]]) != ((1U << 15)-1)) {
   p[i] = expt[(x += ((1U << 15)-1) - lb) >= ((1U << 15)-1) ? x - ((1U << 15)-1) : x];
  }
 }
}
...
static void gfAddMul (gfPoint a, ltemp alpha, ltemp j, gfPoint b)
{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 366, __PRETTY_FUNCTION__));
 while (a[0] < j + b[0]) {
  a[0]++; a[a[0]] = 0;
 }
 for (i = b[0]; i; i--) {
  if ((x = logt[b[i]]) != ((1U << 15)-1)) {
   aj[i] ^= expt[(x += la) >= ((1U << 15)-1) ? x - ((1U << 15)-1) : x];
  }
 }
 while (a[0] && a[a[0]]==0) {
  a[0]--;
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 388, __PRETTY_FUNCTION__));
 ((b != ((void *)0)) ? (void) (0) : __assert_fail ("b != ((void *)0)", "ec_field.c", 389, __PRETTY_FUNCTION__));
 ((a != ((void *)0)) ? (void) (0) : __assert_fail ("a != ((void *)0)", "ec_field.c", 390, __PRETTY_FUNCTION__));
 ((b != a) ? (void) (0) : __assert_fail ("b != a", "ec_field.c", 391, __PRETTY_FUNCTION__));
 if (a[0] == 0) {
 ...
 gfCopy (f, a);
 gfClear (g);
 g[0] = 17 + 1; g[1] = 1; g[3 + 1] = 1; g[17 + 1] = 1;

 for (;;) {
  if (f[0] == 1) {
   ((f[1] != 0) ? (void) (0) : __assert_fail ("f[1] != 0", "ec_field.c", 406, __PRETTY_FUNCTION__));
   gfSmallDiv (b, f[1]);
...
SWAP_GF:
  j = f[0] - g[0];
  x = logt[f[f[0]]] - logt[g[g[0]]] + ((1U << 15)-1);
  alpha = expt[x >= ((1U << 15)-1) ? x - ((1U << 15)-1) : x];
 ...
 for (;;) {
  if (g[0] == 1) {
   ((g[1] != 0) ? (void) (0) : __assert_fail ("g[1] != 0", "ec_field.c", 426, __PRETTY_FUNCTION__));
   gfSmallDiv (c, g[1]);
   gfCopy (b, c);
...
SWAP_FG:
  j = g[0] - f[0];
  x = logt[g[g[0]]] - logt[f[f[0]]] + ((1U << 15)-1);
  alpha = expt[x >= ((1U << 15)-1) ? x - ((1U << 15)-1) : x];
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 452, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 453, __PRETTY_FUNCTION__));
 q[0] = 1; q[1] = b;
 if ((255 - 1) & 1) {
...
{
# 492 "ec_field.c"
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 492, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 493, __PRETTY_FUNCTION__));
...

{
 ...
 ((logt != ((void *)0) && expt != ((void *)0)) ? (void) (0) : __assert_fail ("logt != ((void *)0) && expt != ((void *)0)", "ec_field.c", 528, __PRETTY_FUNCTION__));
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 529, __PRETTY_FUNCTION__));
 ((beta != ((void *)0)) ? (void) (0) : __assert_fail ("beta != ((void *)0)", "ec_field.c", 530, __PRETTY_FUNCTION__));
 ((p != beta) ? (void) (0) : __assert_fail ("p != beta", "ec_field.c", 531, __PRETTY_FUNCTION__));
...
{
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 566, __PRETTY_FUNCTION__));
...

{
 ...
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 577, __PRETTY_FUNCTION__));
 ((k != ((void *)0)) ? (void) (0) : __assert_fail ("k != ((void *)0)", "ec_field.c", 578, __PRETTY_FUNCTION__));
 vlClear (k); a[0] = 1;
 for (i = p[0]; i > 0; i--) {
  vlShortLshift (k, 15);
  a[1] = p[i];
...

{
 ...
 ((p != ((void *)0)) ? (void) (0) : __assert_fail ("p != ((void *)0)", "ec_field.c", 594, __PRETTY_FUNCTION__));
 ((k != ((void *)0)) ? (void) (0) : __assert_fail ("k != ((void *)0)", "ec_field.c", 595, __PRETTY_FUNCTION__));
 vlCopy (x, k);
 for (n = 0; x[0]; n++) {
  p[n+1] = (lunit) (x[1] & ((1U << 15)-1));
  vlShortRshift (x, 15);
 }
 p[0] = n;
}
