...
public class Log implements LayoutCharacters
{
    ...
    /**
     * SwitchStmt: prompt user on each error.
     */
    public boolean promptOnError;

    /**
     * SwitchStmt: emit warning messages.
     */
     ...
     */
    protected Log(Context context, PrintWriter errWriter,
    ...
    private int getIntOption(Options options, String optionName,
            int defaultValue)
    {
    ...
    /**
     * ReturnInst current source name.
     */
    ...
    private void printErrLine(int line, int col, PrintWriter writer)
    {
        try
        {
            ...
            int lineEnd = bp;
            while (lineEnd < buf.length && buf[lineEnd] != CR
                    && buf[lineEnd] != LF)
                lineEnd++;
    ...
    private void printError(int pos, String msg, PrintWriter writer)
    {
        ...
        {
            writer.print(
                    getText("compiler.err.error", null, null, null, null, null,
                            null, null));
            ...
            String arg2, String arg3, String arg4, String arg5, String arg6)
    {
        if (nerrors < MaxErrors)
        {
            ...
            {
                recorded.add(coords);
                String msg = getText("compiler.err." + key, arg0, arg1, arg2,
                        arg3, arg4, arg5, arg6);
    ...
    public void note(String key, String arg0)
    {
        ...
        {
            noticeWriter
                    .print(getText("compiler.note.note", null, null, null, null,
                            null, null, null));
