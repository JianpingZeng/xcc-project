...
import backend.lir.ci.LIRValue.Formatter;
...
public abstract class LIRInstruction
{
	...
	private LIROperand initOutput(LIRValue output)
	{
		...
		if (output != LIRValue.IllegalValue)
		{
			...
			return new LIROperand.LIRVariableOperand(allocatorOperands.size() - 1);
		}
		else
		{
			return ILLEGAL_SLOT;
	...
	private LIROperand addAddress(LIRAddress LIRAddress)
	{
		...
		if (base != -1 || index != -1)
		{
			return new LIROperand.LIRAddressOperand(base, index, LIRAddress);
		}
