...
import backend.analysis.LiveAnalysis;
import backend.analysis.LiveAnalysis.VarInfo;
...
public final class TwoAddrInstruction extends MachineFunctionPass
{
	...
	public boolean runOnMachineFunction(MachineFunction mf)
	{
		...
		LiveAnalysis la = getAnalysisToUpDate(LiveAnalysis.class);
	...
	{
		au.addRequired(LiveAnalysis.class);
		au.addPreserved(LiveAnalysis.class);
