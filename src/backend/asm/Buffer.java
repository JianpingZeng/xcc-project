...
import tools.NumUtil;

import java.util.Arrays;

/**
 * Code buffer management for the assembler. Support for little endian and big
 * endian architectures is implemented using subclasses.
 */
public abstract class Buffer
{
	 ...
	 * this call.
	 *
	 * @param trimmedCopy if {@code true}, then a copy of the underlying byte array up
	...
	{
		@Override public int emitShort(int b, int pos)
		{
		...
		@Override public int emitInt(int b, int pos)
		{
			ensureSize(pos + 4);
		...
		@Override public int emitLong(long b, int pos)
		{
			ensureSize(pos + 8);
		...
		@Override public int getShort(int pos)
		{
			return (data[pos + 0] & 0xff) << 8 | (data[pos + 1] & 0xff) << 0;
		}

		@Override public int getInt(int pos)
		{
