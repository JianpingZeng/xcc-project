...
/**
 * This file defines the MachineDomTree class, which provides fast and efficient
...
public final class MachineDomTree
{
     ...
     */
    public MachineDomTree(boolean isPostData)
    {
    ...
    {
        m = mf;
        this.Vertex = new MachineBasicBlock[m.getNumMBB()];
        if (!IsPostDominators)
        {
            // initialize the root
            MachineBasicBlock entry = m.getEntryBlock();
