...
public final class ScalarEvolution extends FunctionPass
{
    ...
    static class ScalarEvolutionImpl
    {
         ...
         * @return
         */
        public SCEV createSCEV(Value val)
        {
            if (val instanceof Instruction)
            {
                ...
                switch (inst.getOpcode())
                {
                    ...
                    case SDiv:
                        ...
                        break;
                    case Sub:
                        return SCEV.getMinusSCEV(getSCEV(inst.operand(0)),
                                getSCEV(inst.operand(1)));
                    case Shl:
         ...
         * @param con
         */
        public void replaceSymbolicValueWithConcrete(Instruction val, SCEV sym, SCEV con)
        {
        ...
        public static Constant constantFold(Instruction inst, ArrayList<Constant> operands)
        {
        ...
        public static boolean canConstantFold(Instruction inst)
        {
         ...
         * @return
         */
        public static SCEV getTruncateOrZeroExtend(SCEV value, Type ty)
        {
    ...
    /**
     * <p>
     * Return a SCEV expression handle for the specified value
     ...
     * @return
     */
    public SCEV getSSCEVAtScope(Value val, Loop loop)
    {
        return impl.getSCEVAtScope(getSCEV(val), loop);
    }

    /**
     * If the specified loop has a predictable iteration
    ...
    public SCEV getIterationCount(Loop loop)
    {
        return impl.getIterationCount(loop);
    }
    ...
    public boolean hasLoopInvariantIterationCount(Loop loop)
    {
        return impl.hasLoopInvariantIterationCount(loop);
    }
