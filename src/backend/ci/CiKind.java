...
import static backend.ci.CiKind.Flags.PRIMITIVE;
import static backend.ci.CiKind.Flags.RETURN_TYPE;
import static backend.ci.CiKind.Flags.VAR_TYPE;
...
public enum CiKind {
    ...
    public static final CiKind[] JAVA_VALUES = new CiKind[] {CiKind.Boolean, CiKind.Byte, CiKind.Short, CiKind.Char, CiKind.Int, CiKind.Float, CiKind.Long, CiKind.Double};
