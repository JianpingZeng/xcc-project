...
import static cparser.DeclSpec.SCS.SCS_typedef;
import static cparser.DeclSpec.TQ.TQ_const;
import static cparser.DeclSpec.TQ.TQ_restrict;
import static cparser.DeclSpec.TQ.TQ_volatile;
import static cparser.DeclSpec.TSC.TSC_complex;
import static cparser.DeclSpec.TSS.TSS_signed;
import static cparser.DeclSpec.TSS.TSS_unsigned;
import static cparser.DeclSpec.TST.*;
import static cparser.DeclSpec.TSW.TSW_long;
import static cparser.DeclSpec.TSW.TSW_short;
import static cparser.Parser.ParenParseOption.CastExpr;
import static cparser.Parser.ParenParseOption.CompoundLiteral;
import static cparser.Parser.ParenParseOption.SimpleExpr;
import static sema.Sema.TagUseKind.TUK_declaration;
import static sema.Sema.TagUseKind.TUK_definition;
import static sema.Sema.TagUseKind.TUK_reference;

/**
 * This is a parser for C language.
 * <p>
 * The parser map a token sequence into an abstract syntax tree. It operates by
...
public class Parser implements Tag
{
    ...
    static class ParseScope
    {
         ...
         * parser self where the new scope is createed with the flags.
         * @param self
         * @param scopeFlags
         */
     ...
     * //TODO  '(' type-name ')' '{' initializer-list '}'
     * //TODO  '(' type-name ')' '{' initializer-list ',' '}'
    ...
    /**
     * For sufficiency, A simple precedence-based parser for binary/unary operators.
     * <br>
    ...
    private boolean parseImplicitInt(DeclSpec ds)
    {
        ...
        // IfStmt we see an identifier that is not a type name, we normally would
    ...
    private void parseFunctionDeclarator(Declarator declarator)
    {
        ...
        // TODO: remenber that we parsed a function type
