...
public final class TGParser implements TGParserConstants
{
    ...
    /**
     * Add all of record values of {@code rec} to curRec, resolving templateArgs as
            ...
            else
            {
                switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk)
                {
                    ...
                    case SHLTOK:
                    {
                        ...
                        {
                            if ("" != null)
                                return new BinOpInit(BinOpInit.BinaryOp.SHL,
                                        res, res2).fold();
                        }
                        break;
                    }
                    case SRATOK:
                    {
                        ...
                        {
                            if ("" != null)
                                return new BinOpInit(BinOpInit.BinaryOp.SRA,
                                        res, res2).fold();
                        }
                        break;
                    }
                    case SRLTOK:
                    {
                        ...
                        {
                            if ("" != null)
                                return new BinOpInit(BinOpInit.BinaryOp.SRL,
                                        res, res2).fold();
                        }
                        break;
                    }
                        ...
                        jj_consume_token(RPAREN);
                        {
                            if ("" != null)
                                return new BinOpInit(
                                        BinOpInit.BinaryOp.STRCONCAT, res, res2)
                                        .fold();
                        }
                        break;
                    }
    ...
    {
        jj_la1_0 = new int[] { 0x8007f0, 0x0, 0x4acf0000, 0x40000000,
                0x40000000, 0x0, 0x4acf0000, 0x4acf0000, 0x400000, 0x0, 0x0,
                0x4acf0000, 0x0, 0x6000, 0x6000, 0x0, 0x800000, 0x0, 0x0, 0x0,
                0x0, 0x800000, 0x0, 0x5800, 0x5800, 0x5800, };
    }

    private static void jj_la1_init_1()
    {
        jj_la1_1 = new int[] { 0x0, 0x100, 0x205, 0x41, 0x41, 0x10, 0x205,
                0x205, 0x0, 0x80, 0x1, 0x205, 0x80, 0x0, 0x0, 0x21, 0x0, 0x80,
                0x10, 0x80, 0x800, 0x0, 0x80, 0x1, 0x0, 0x0, };
    }
