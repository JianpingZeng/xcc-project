...
/**
 * The jlang.parser that parses the micro-c source file.
...
public class Parser implements ParserConstants
{
	...
	final public Tree.TopLevel compilationUnit() throws ParseException
	{
		...
		try
		{// two list that contain import clauses or jlang.type definition respectively
		...
		try
		{
			...
			switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk)
			{
				case 57:
				{
					...
					// "," "}" { return F.at(pos).NewArray(jlang.type, Tree.emptyList, elems); }
	...
	/**
	 * handles to jlang.type syntax construct.
	 */
	final public Tree type() throws ParseException
	{
		trace_call("jlang/type");
		try
		{
			Tree ref;
			// basic jlang.type reference, such as void, char, int, long etc.
			ref = baseType();
			label_9:
			while (true)
			{
				...
				jj_consume_token(60);
				jj_consume_token(61);
				// array jlang.type reference to no getArraySize
		...
		{
			trace_return("jlang/type");
		}
	}

	/**
	 * Parses the base jlang.type.
	 */
	...
	/**
	 * Parses jlang.type cast or unary subExpr
	 */
	 ...
	 * supported as primitive jlang.type rather than no aggregate or class.
	 */
