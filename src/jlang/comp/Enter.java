...
import jlang.symbol.Symbol.TopLevelSymbol;
...
/**
 * <p>This class enters symbols for all encountered definition into the jlang.symbol
...
public class Enter extends StmtVisitor implements TypeClass, SymbolKinds, Flags
{
	...
	/**
	 * Maps method jlang.symbol to env attached to it.
	 * <p>This map is used for memorizing the method jlang.symbol and corresponding
	 ...
	 * Every scope is attached to adaptable jlang.symbol.
	 *
	 * @param tree
	 */
	...
	/**
	 * Checks the unique jlang.symbol in the given scope.
	 * 
	 * @param pos	The position of jlang.symbol to be error reported.
	 * @param sym		The jlang.symbol.
	...
	private boolean checkUnique(int pos, Symbol sym, Scope encScope)
	{
		...
		// look up the jlang.symbol whose getName as same as given jlang.symbol at current scope
	...
	/**
	 * Reports a duplicate jlang.symbol error at given postion of source file.
	 * 
	 * @param pos	The position to be error reported.
	 * @param sym	The jlang.symbol to be error reported.
	 */
	...
	/**
	 * Constructs a method signature according to return jlang.type,
	 * parameters list of method.
	 * 
	 * @param params	The parameters list of this method.
	 * @param rettype	The return value' jlang.type.
	...
	/**
	 * Enters the jlang.symbol of variable definition into current scope used by
	...
	/**
	 * Enters the jlang.symbol of method definition into current scope used by
