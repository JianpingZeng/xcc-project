...
public class ConstFold implements TypeClass, OpCodes
{
	...
	/**
	 * Fold binary or unary operation, returning constant jlang.type reflecting the
	 ...
	 * @param operand The operation's LIROperand jlang.type. Argument types are assumed
	 ...
	 *            as entered by class Symtab. opcode's ifeq to ifge are for
	 *            postprocessing xcmp; ifxx pairs of instructions.
	 * @param left The jlang.type of the operation's left LIROperand.
	 * @param right The jlang.type of the operation's right LIROperand.
	 */
	...
	/**
	 * Coerce constant jlang.type to targetAbstractLayer jlang.type.
	 * 
	 * @param sourcetype The source jlang.type of the coercion, which is assumed to be
	 *            a constant jlang.type compatible with targetAbstractLayer jlang.type.
	 * @param targettype The targetAbstractLayer jlang.type of the coercion.
	 */
