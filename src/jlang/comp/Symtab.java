...
import tools.*;
import jlang.symbol.*;
import jlang.symbol.TypeSymbol;
 ...
 * driver. All symbols are held in instance fields. This makes it possible to
...
public class Symtab implements Flags, OpCodes
{
	...
	/**
	 * The context key for the jlang.symbol table.
	 */
	private static final Context.Key symtabKey = new Context.Key();

	/**
	 * Get the jlang.symbol table instance.
	 */
	...
	/**
	 * A jlang.symbol that stands for a missing jlang.symbol.
	 */
	public final TypeSymbol noSymbol;

	/**
	 * The error jlang.symbol.
	 */
	...
	/**
	 * A value for the unknown jlang.type.
	 */
	public final Type unknownType;

	/**
	 * The predefined jlang.type that belongs to a tag.
	 */
	...
	/**
	 * Enter a unary operation into jlang.symbol table.
	 * @param name The getName of the operator.
	 * @param arg The jlang.type of the LIROperand.
	 * @param res The operation's result jlang.type.
	...
	/**
	 * Constructor; enters all predefined identifiers and operators into jlang.symbol
	 * table.
	 */
