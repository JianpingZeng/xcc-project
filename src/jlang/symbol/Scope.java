...
public class Scope
{
	...
	/**
	 * Enter jlang.symbol sym in this scope.
	 */
	...
	/**
	 * Enter jlang.symbol sym in this scope, but mark that it comes from
	...
	/**
	 * Enter jlang.symbol sym in this scope if not already there.
	 */
	public void enterIfAbsent(Symbol sym)
	{
		Entry e = lookup(sym.name);
		// firstly, search the jlang.symbol its getName as same as given sym
	...
	/**
	 * An error scope, for which the owner should be an error jlang.symbol.
	 */
