 ...
 * because of problems with the function. This frontend.exception is <i>not</i>
...
public class CiBailout extends RuntimeException
{
	...
	/**
	 * Create a new {@code CiBailout} t due to an internal frontend.exception being thrown.
	 *
	 * @param reason a message indicating the reason
