...
import frontend.symbol.TypeSymbol;
...
public class Symtab implements Flags, OpCodes
{
	...
	/**
	 * The context key for the frontend.symbol table.
	 */
	private static final Context.Key symtabKey = new Context.Key();

	/**
	 * Get the frontend.symbol table instance.
	 */
	...
	/**
	 * A frontend.symbol that stands for a missing frontend.symbol.
	 */
	public final TypeSymbol noSymbol;

	/**
	 * The error frontend.symbol.
	 */
	...
	/**
	 * A value for the unknown frontend.type.
	 */
	public final Type unknownType;

	/**
	 * The predefined frontend.type that belongs to a tag.
	 */
	...
	/**
	 * Constructor; enters all predefined identifiers and operators into frontend.symbol
	 * table.
	 */
