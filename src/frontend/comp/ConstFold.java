...
public class ConstFold implements TypeClass, OpCodes
{
	...
	/**
	 * Fold binary or unary operation, returning constant frontend.type reflecting the
	 ...
	 * @param operand The operation's LIROperand frontend.type. Argument types are assumed
	 ...
	 *            as entered by class Symtab. opcode's ifeq to ifge are for
	 *            postprocessing xcmp; ifxx pairs of instructions.
	 * @param left The frontend.type of the operation's left LIROperand.
	 * @param right The frontend.type of the operation's right LIROperand.
	 */
	...
	/**
	 * Coerce constant frontend.type to targetAbstractLayer frontend.type.
	 * 
	 * @param sourcetype The source frontend.type of the coercion, which is assumed to be
	 *            a constant frontend.type compatible with targetAbstractLayer frontend.type.
	 * @param targettype The targetAbstractLayer frontend.type of the coercion.
	 */
