...
public class FunctionType extends Type
{
     ...
     * @param returnType indicates what frontend.type would be returned.
     * @param paramTypes indicates the parameters frontend.type list would be passed into
     *                   function body.
    ...
    /**
     * A private function for comparing two frontend.type list.
     * @param list1
     * @param list2
     * @return
     */
