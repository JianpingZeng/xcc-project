...
import frontend.cparser.DeclContext;
import frontend.cparser.DeclKind;
import frontend.cparser.Declarator;
...
import static frontend.cparser.DeclKind.*;
import static frontend.type.Type.TagTypeKind.TTK_enum;
import static frontend.type.Type.TagTypeKind.TTK_struct;
import static frontend.type.Type.TagTypeKind.TTK_union;
...
public abstract class Decl extends DeclContext
{
    ...
    {
        /**
         * This indicates the frontend.type object that represents this typeDecl.
         */
    ...
    {
        /**
         * The integer frontend.type that values of this frontend.type should promote to.
         ...
         * @param newType  Indicates that underlying frontend.type of this forward declaration.
         */
     ...
     * EnumConstantDecl's, X is an instance of EnumDecl, and the frontend.type of a/b is a
