...
/**
 * The kind of operator required for frontend.type conversion.
 * @author Xlous.zeng
 * @version 0.1
 */
public enum CastKind
{
    ...
    /// CK_BitCast - A conversion which causes a bit pattern of one frontend.type
    /// to be reinterpreted as a bit pattern of another frontend.type.  Generally
    ...
    /// from any pointer frontend.type to a C pointer frontend.type is a bitcast unless
    ...
    /// CK_NoOp - A conversion which does not affect the frontend.type other than
    ...
    /// complex of the original frontend.type.  Injects the value as the real
    /// component with a zero imaginary component.
    ///   float -> _Complex float
    CK_FloatingRealToComplex,

    /// \brief Converts a floating point complex to floating point real
    /// of the source's element frontend.type.  Just discards the imaginary
    /// component.
    ...
    /// whose element frontend.type matches the source.  Injects the value as
    /// the real component with a zero imaginary component.
    ///   long -> _Complex long
    CK_IntegralRealToComplex,

    /// \brief Converts an integral complex to an integral real of the
    /// source's element frontend.type by discarding the imaginary component.
