...
public interface Flags {
    ...
    /**
     * Flag is set for a variable frontend.symbol if variable's definition
     * has initializer part.
     */
    int HASINIT = 1 << 13;
    
    /**
     * The flag set when this method frontend.symbol is unattributed before attributing phase.
     */
