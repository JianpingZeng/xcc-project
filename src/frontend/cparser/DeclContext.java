 ...
 *
 * @see frontend.sema.Decl.TranslationUnitDecl
 * @see frontend.sema.Decl.FunctionDecl
 * @see frontend.sema.Decl.TagDecl
 * @see frontend.sema.Decl.EnumDecl
 * @see frontend.sema.Decl.RecordDecl
 *
 * @author Xlous.zeng
 * @version 0.1
 */
