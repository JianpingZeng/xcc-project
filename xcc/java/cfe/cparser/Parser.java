...
import cfe.ast.Tree.Stmt;
import cfe.clex.CommentHandler.DefaultCommentHandler;
import cfe.clex.*;
import cfe.cparser.DeclSpec.DeclaratorChunk;
import cfe.cparser.DeclSpec.FieldDeclarator;
import cfe.cparser.DeclSpec.ParamInfo;
import cfe.cparser.DeclSpec.ParsedSpecifiers;
import cfe.cparser.Declarator.TheContext;
import cfe.diag.*;
import cfe.sema.Decl;
import cfe.sema.Decl.LabelDecl;
import cfe.sema.PrecedenceLevel;
import cfe.sema.Scope;
import cfe.sema.Scope.ScopeFlags;
...
import static cfe.clex.TokenKind.Enum;
import static cfe.cparser.DeclSpec.SCS.*;
import static cfe.cparser.DeclSpec.TQ.*;
import static cfe.cparser.DeclSpec.TSC.TSC_complex;
import static cfe.cparser.DeclSpec.TSS.TSS_signed;
import static cfe.cparser.DeclSpec.TSS.TSS_unsigned;
import static cfe.cparser.DeclSpec.TST.*;
import static cfe.cparser.DeclSpec.TSW.*;
import static cfe.cparser.Declarator.TheContext.FileContext;
import static cfe.cparser.Parser.ParenParseOption.*;
import static cfe.sema.Scope.ScopeFlags.DeclScope;
import static cfe.sema.Scope.ScopeFlags.FunctionProtoTypeScope;
import static cfe.sema.Sema.TagUseKind.*;
