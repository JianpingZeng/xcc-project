...
public abstract class ArrayType extends Type implements FoldingSetNode {
   ...
   */
  public static class ConstantArrayType extends cfe.type.ArrayType implements FoldingSetNode {
    private APInt size;
   ...
   * </pre>
   */
  public static class VariableArrayType extends cfe.type.ArrayType {
    /**
   ...
   */
  public static class IncompleteArrayType extends cfe.type.ArrayType {
    /**
     * Constructor with one parameter which represents the kind of jlang.type
     * for reason of comparison convenient.
     *
