...
public class CodeGenModule {
  ...
  private void setGlobalVisibility(Decl d, GlobalValue gv) {
    ...
    switch (getDeclVisibilityMode(d)) {
      default:
        Util.assertion(false, "Unknown visibility!");
