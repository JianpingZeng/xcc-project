...
public enum DiagnosticLexKinds implements DiagnosticLexKindsTag {
  ...
  ERR_DEFINED_MACRO_NAME(err_defined_macro_name, CLASS_ERROR, MAP_ERROR, "'defined' cannot be used as a macro asmName"),
  ...
  ERR_PP_DUPLICATE_NAME_IN_ARG_LIST(err_pp_duplicate_name_in_arg_list, CLASS_ERROR, MAP_ERROR, "duplicate macro parameter asmName %0"),
  ...
  ERR_PP_MISSING_MACRO_NAME(err_pp_missing_macro_name, CLASS_ERROR, MAP_ERROR, "macro asmName missing"),
  ...
  ERR_PP_OPERATOR_USED_AS_MACRO_NAME(err_pp_operator_used_as_macro_name, CLASS_ERROR, MAP_ERROR, "C++ operator '%0' cannot be used as a macro asmName"),
  ...
  ERR_UCN_ESCAPE_INCOMPLETE(err_ucn_escape_incomplete, CLASS_ERROR, MAP_ERROR, "incomplete universal character asmName"),
  ...
  ERR_UCN_ESCAPE_TOO_BIG(err_ucn_escape_too_big, CLASS_ERROR, MAP_ERROR, "universal character asmName is too long"),
  ...
  EXT_C99_WHITESPACE_REQUIRED_AFTER_MACRO_NAME(ext_c99_whitespace_required_after_macro_name, CLASS_NOTE, MAP_WARNING, "ISO C99 requires whitespace after the macro asmName"),
  ...
  EXT_MISSING_WHITESPACE_AFTER_MACRO_NAME(ext_missing_whitespace_after_macro_name, CLASS_NOTE, MAP_WARNING, "whitespace required after macro asmName"),
  ...
  WARN_MISSING_WHITESPACE_AFTER_MACRO_NAME(warn_missing_whitespace_after_macro_name, CLASS_WARNING, MAP_WARNING, "whitespace recommended after macro asmName"),
  ...
  WARN_PRAGMA_DIAGNOSTIC_INVALID_OPTION(warn_pragma_diagnostic_invalid_option, CLASS_NOTE, MAP_WARNING, "pragma diagnostic expected option asmName (e.g. \"-Wundef\")"),
