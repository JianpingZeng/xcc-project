...
import cfe.cparser.DeclKind;
import cfe.sema.Decl.NamedDecl;
import cfe.type.TagType;
import cfe.type.Type;
import tools.Util;

import java.util.ArrayList;
import java.util.List;

import static cfe.cparser.DeclKind.*;
 ...
 * @version 0.4
 * @see cfe.sema.Decl.TranslationUnitDecl
 * @see cfe.sema.Decl.FunctionDecl
 * @see cfe.sema.Decl.TagDecl
 * @see cfe.sema.Decl.EnumDecl
 * @see cfe.sema.Decl.RecordDecl
 */
